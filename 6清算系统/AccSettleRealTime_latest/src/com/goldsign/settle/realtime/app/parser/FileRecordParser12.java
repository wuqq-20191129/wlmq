 ...
 * 12.13. TVM自动结存数据
 */
public class FileRecordParser12 extends FileRecordParserBase{

    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecord12 r = new FileRecord12();
    ...
    private FileRecord00DetailResult getInfoForCommon(FileRecord12 r, char[] b, int offset) throws Exception {

 ...
 * @author hejj
 */
public class FileRecordParserMobile54 extends FileRecordParserBase {

    private static Logger logger = Logger.getLogger(FileRecordParserMobile54.class.getName());

    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecordMobile54 r = new FileRecordMobile54();
    ...
    private FileRecord00DetailResult getInfoForDevice(FileRecordMobile54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

        int len = 2;
        // r.setTrdType(this.getCharString(b, offset, len));//交易类型
        r.setTrdType(this.getTrdTypeForMobile(this.getCharString(b, offset, len)));//交易类型增加前缀Mobile 即Mobile54
        offset += len;
    ...
    private FileRecord00DetailResult getInfoForTrade(FileRecordMobile54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
        ...
        r.setDealBalanceFee_s(TradeUtil.convertFenToYuan(r.getDealBalanceFee()).toString());
        offset += len;
        ...
        r.setBuyTkUnitFee_s(TradeUtil.convertFenToYuan(r.getBuyTkUnitFee()).toString());
        offset += len;
    ...
    private String getCheckUniqueKey(FileRecord54 r) {
        ...
        String key = r.getCardMainId() + r.getCardSubId()
                ...
                + r.getDealDatetime() + r.getDealFee() + r.getDealBalanceFee()+r.getCardLogicalId()

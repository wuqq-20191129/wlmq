...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="ES制卡统计"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_card_main_type#p_card_sub_type#p_begin_day#p_end_day#p_operator_id#p_worktype_id#p_device_id"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_card_main_type#p_card_sub_type#p_begin_day#p_end_day#bufferFlag#p_operator_id#p_worktype_id#p_device_id"/>

 ...
 * @author mh
 */
public class FileQrCode56App71 extends FileBase{
     public static String serialNo = "056";

    public static void main(String[] arg) {
        FileQrCode56App71 ft = new FileQrCode56App71();
        //  String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX7100." + ft.getCurrentDate() + "." + FileQrCode56App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"7100", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 1};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {
            "56", "12", "0103", "03", "001",
            "8300000302A00001", 100, "1100", "8300000300000001", "8A563201",
            101, 111, "1", "01", this.getDealDatetime(),
            "01", 500, "0001", "999999", "0103",
            "01", "0", "000", "0000", "0000",
            "1", this.getDealDatetime(),"0000000000000000000000000000000000000001", "0000000000000000000000000000000000000002","02"
        };
        /**
         * *****************更新信息*************
         */

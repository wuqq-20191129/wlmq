...
public class LineDao {
    ...
    public Vector getLineAll() throws Exception {
        ...
        String sql = "select line_id,line_name from w_acc_st.w_op_prm_line where record_flag=? order by line_id";
        Object[] values = {"0"};
    ...
    public Vector getLineList() throws Exception {
        ...
        try {
            dbHelper = new DbHelper("",AppConstant.dbcpHelper1.getConnection());
            strSql = "select line_id,line_name from w_acc_st.w_op_prm_line where record_flag = '0' order by line_id";

 ...
 */
public class EmployeePrintQueryPanel extends javax.swing.JPanel {
    ...
    public EmployeePrintQueryPanel() {
    ...
    private void initComponents() {
        ...
        countSPn = new javax.swing.JScrollPane();
        ...
        jLabelIDType = new javax.swing.JLabel();
        ...
        mainPnlLayout.setHorizontalGroup(
            ...
            .add(jTextField5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 821, Short.MAX_VALUE)
            .add(mainSPn)
            .add(countSPn)
        );
        mainPnlLayout.setVerticalGroup(
            ...
            .add(mainPnlLayout.createSequentialGroup()
                ...
                .add(countSPn, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(mainSPn, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE))
        );
        ...
        jLabelApplyTime.setText(" 打印时间：");

        IDTypeCb.setFont(new java.awt.Font("宋体", 0, 16)); // NOI18N
        IDTypeCb.setForeground(new java.awt.Color(0, 39, 80));
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jLabelApplyTime)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(begDateCb, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 119, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jLabel4)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(endDateCb, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 119, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(18, 18, 18)
                        .add(jLabelIDType, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 77, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(IDTypeCb, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 111, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .add(45, 45, 45)
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel1Layout.createSequentialGroup()
                        ...
                        .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                                .add(IDTypeCb, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(btExport))
                            .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
    ...
    private javax.swing.JScrollPane countSPn;
    ...
    private SignCardPrintVo getCallParam(){
        ...
        param.setName(nameTxt.getText().trim());
        SelectOptionVo IDTypeOption = (SelectOptionVo)IDTypeCb.getSelectedItem();
        param.setIdentityType(IDTypeOption.getValue());
        SelectOptionVo CardTypeOption = (SelectOptionVo)CardTypeCb.getSelectedItem();
        param.setCardType(CardTypeOption.getValue());
    ...
    private void doQuery(){
        ...
        //分类统计
        List<Object[]> countList = printService.getCountList(printParam);
        
        MessageShowUtil.infoOpMsg("成功查询" + printList.size() + "条记录");
        //生成列表
        genMainResultSetTable(printList);
        genCountResultSetTable(countList);
     ...
     * @param result 
     */
    private void genCountResultSetTable(List<Object[]> result) {
        //列名称
        String[] columnNames = {"类型", "数量"};
        //列宽度
        int[] columnSize = {300, 300};
        
        //生成列表
        UIUtil.genResultSetTable(this.countSPn, result, columnNames, columnSize);
    }
    ...
    private void genMainResultSetTable(List<Object[]> result) {
        //列名称
        String[] columnNames = {"姓名", "证件类型", "证件号", "票卡类型", "职务", "部门", "性别", "操作员", "打印时间", "相片名称", "逻辑卡号", "票卡类型代码" ,"证件类型代码", "部门代码" ,"职务代码"};
        //列宽度
        int[] columnSize = {70, 100, 200, 150, 120, 120, 40, 100, 200, 250, 150, 0, 0, 0, 0};
        //生成列表
        resultSetTableMain = UIUtil.genResultSetTable(this.mainSPn, result, columnNames, columnSize);
        UIUtil.hideTableColumns(resultSetTableMain, new int[]{11, 12, 13, 14});//隐藏列
    }
    
    /*
     * 表单检验提示
     */
    public boolean checkParam(SignCardPrintVo printParam) {
        boolean result = true;

        result = PubUtil.checkQueryTime(printParam.getBeginTime(),printParam.getEndTime());
    ...
    private void addItemIdentityType() {
        this.IDTypeCb.removeAllItems();
        this.IDTypeCb.addItem(new SelectOptionVo("", "全部"));
        Set<String> dkey = AppConstant.CERTIFICATE_TYPE.keySet();
        for (Iterator it = dkey.iterator(); it.hasNext();) {
            String s = (String) it.next();
            this.IDTypeCb.addItem(new SelectOptionVo(s, String.valueOf(AppConstant.CERTIFICATE_TYPE.get(s))));
        }
    }
    ...
    private void doExport() {
        resultSetTableMain.setName("记名卡信息");

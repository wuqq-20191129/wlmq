 ...
 * @author goldsign
 */
public class TestSocket55 extends Thread{
...
//    public static final String ipAddress = "210.21.94.85";
    ...
    public static void main(String[] args) {
        TestSocket55 myThread;
        myThread = new TestSocket55();
        myThread.run();
    }
    ...
    public void run(){
        ...
        try {
            ...
            for (int i=0; i<3; i++) {
                ...
                if(i==0){
                    Message55Vo vo = new Message55Vo();
                    vo.setRandomNum("0000000000000000");
                    vo.setSamLogicalId("0000008000000000");
//                    vo.setTerminalNo("011803154");
                    vo.setTerminalNo("020803002");
...
//                    socket.close();
    ...
    private byte[] data(Message55Vo vo){
        byte[] b = new byte[50];
        System.arraycopy("55".getBytes(), 0, b, 0, 2);//消息类型
        ...
        System.arraycopy(vo.getRandomNum().getBytes(), 0, b, 34, 16);//随机数
        return b;
    }

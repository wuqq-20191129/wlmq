 ...
 * @author hejj
 */
public class BufferToQueue74Dao extends BufferToQueueBaseDao{
    ...
    public ResultFromProc bufToQueue(String balanceWaterNo, int balanceWaterNoSub, String fileName) throws Exception {
        // synchronized (SYN) {
        return this.bufToQueueCommon(balanceWaterNo, balanceWaterNoSub, fileName, "up_st_trf_btoq_deal_qrcode");
        //  }
    }

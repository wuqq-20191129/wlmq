    ...
    <head>
        ...
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">内部清算类报表--线路清分结果月报表
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="InnerLineDispartByMonth">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="InnerLineDispartByMonth"/>
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
        ...
        <c:set var="note" scope="request" value="线路清分结果月报表"/>

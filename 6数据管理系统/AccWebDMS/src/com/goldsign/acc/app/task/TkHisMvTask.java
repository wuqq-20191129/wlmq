 ...
 */
public class TkHisMvTask extends BaskTask {

    private static Logger logger = Logger.getLogger(TkHisMvTask.class);
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.TK_USER + "w_up_dm_tk_his_mv", AppCodeConstant.TYPE_RESULT);

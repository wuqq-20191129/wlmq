...
public class ResultFromProc {
    ...
    /**
     * @param iRetValue the iRetValue to set
     */
    public void setiRetValue(int iRetValue) {
        this.iRetValue = iRetValue;
    }
    private int retCode;
    ...
    public ResultFromProc(int retCode,String retMsg,String retValue){
     ...
     public ResultFromProc(int retCode,String retMsg,int iRetValue){
        this.retCode = retCode;
        this.retMsg = retMsg;
        this.iRetValue = iRetValue;

...
import com.goldsign.settle.realtime.app.dao.ExportTccEntryLineAllMinDao;
import com.goldsign.settle.realtime.app.dao.ExportTccEntryLineTkMinDao;
 ...
 * @author hejj
 */
public class TccEntryLineTkMin extends FileTccBase{
    private static Logger logger = Logger.getLogger(TccEntryLineAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟线路分票种进站量";
    private static String PROCEDURE_NAME="w_up_st_tcc_EntryLineTkMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccEntryLineTkMinDao dao = new ExportTccEntryLineTkMinDao();

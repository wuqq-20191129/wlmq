<%-- 
    Document   : lcc_line_type
    Created on : 2017-10-26, 16:22:29
    Author     : liudezeng
--%>
...
<html>
    ...
    <body onload="
        ...
        <div id="clearStartBlock" style="height: 85%;margin-left: 58px;" >
            <div id="clearStartHead" class="divForTableBlockHead" style="width: 89%">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd" class="table_list_tr_col_head_block"  style="width: 87%">通知线路</td>
                    </tr>
            ...
            <div id="clearStart"  class="divForTableBlockData" style=" height: 100%; width: 89%">
                <table class="table_list_block" id="DataTable"  >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            <td   class="table_list_tr_col_data_block" style="width:87%">
                                ${rs.code_text}
                            </td>
                        </tr>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="" >
            ...
            <center>
                ...
                <input type="hidden" id="hiddenValue" name = "hiddenValue" value="${d_rechargeDeviceType}" />

 ...
 */
public class StRptCreateTask3 extends BaskTask {

    private static Logger logger = Logger.getLogger(StRptCreateTask3.class);

    private String taskName;

    public StRptCreateTask3() {
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.OP_USER + "w_up_dm_st_rpt_create3", AppCodeConstant.TYPE_RESULT);

...
<html>
    ...
    <body onload="initDocument('queryOp', 'detail');
        ...
        <form method="post" name="queryOp" id="queryOp" action="BlackListOct">
            <!-- 页面用到的变量 通用模板 -->
...
<!--             <input type="hidden" name="expAllFields" id="d_expAllFields" value="CARD_LOGICAL_ID,CREATE_DATETIME,BLACK_TYPE,OPERATOR_ID,GEN_DATETIME,ACTION_TYPE,REMARK" /> -->
			...
			<input type="hidden" name="expFileName" id="d_expFileName" value="一卡通黑名单.xlsx" />
			<input type="hidden" name="divId" id="d_divId" value="clearStartHead" />
			<input type="hidden" name="methodUrl" id="d_methodUrl" value="/BlackListOctExportAll" />

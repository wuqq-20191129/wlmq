...
import com.goldsign.systemmonitor.dao.NtpIccsSynDao;
...
public class NtpIccsSynAct extends BaseAction {

    public NtpIccsSynAct() {
        super();
    }
    ...
    public ActionForward processLogic(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        NtpIccsSynDao dao = new NtpIccsSynDao();
    ...
    public ActionMessage query(HttpServletRequest request, NtpIccsSynDao pmb, Vector statues, String command) throws Exception {

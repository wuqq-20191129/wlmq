 ...
 * @author hejj
 */
public class RealtimeReportDao {
    private static Logger logger = Logger.getLogger(RealtimeReportDao.class.getName());
    public ResultFromProc genRealtimeReport() throws Exception {

        String sql = "{call "+FrameDBConstant.DB_ST+"W_UP_ST_SYS_GEN_RTTIME_RPT(?,?)} ";//存储过程调用语句
        ...
        int[] pInIndexes = {};//存储过程输入参数索引列表索引从1开始

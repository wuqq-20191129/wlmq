...
import com.goldsign.settle.realtime.app.dao.ExportTccOdStationAllDayDao;
 ...
 * @author hejj
 */
public class TccOdStationAllDay extends FileTccBase{
     private static Logger logger = Logger.getLogger(TccEntryStationAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "日车站OD客流量";
     private static String PROCEDURE_NAME="w_up_st_tcc_OdStationAllDay";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccOdStationAllDayDao dao = new ExportTccOdStationAllDayDao();

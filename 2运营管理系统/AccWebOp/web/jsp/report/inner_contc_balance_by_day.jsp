...
<html>
    <head>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="InnerContcBalanceByDay">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="InnerContcBalanceByDay"/>
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
        ...
        <c:set var="note" scope="request" value="运营商结算日报表"/>

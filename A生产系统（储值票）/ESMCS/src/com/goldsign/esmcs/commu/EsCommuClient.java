...
import com.goldsign.esmcs.vo.EsCommuReadResult;
import com.goldsign.esmcs.vo.EsCommuWriteParam;
...
public class EsCommuClient {
    ...
    public static void sendData(byte[] msg) throws IOException {
        send(msg, getClientSerialNo());//limingjin
    }
    ...
    public static EsCommuReadResult readData(){
       ...
       Vector rv = read();//limingjin
        String rc = (String) rv.get(0);//limingjin
        byte[] rd = (byte[]) rv.get(1);//limingjin
        //String rd1 = (String) rv.get(1);//limingjin
       // String rc = "0100";//limingjin
       // byte[] rd = {'0','0','0','7','1'};//limingjin
        result.setCode(rc);
        result.setData(rd);

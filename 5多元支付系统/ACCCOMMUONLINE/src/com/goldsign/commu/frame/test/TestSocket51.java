 ...
 * @author goldsign
 */
public class TestSocket51 extends Thread{
...
//    public static final String ipAddress = "127.0.0.1";
    ...
    public static void main(String[] args) {
        TestSocket51 myThread;
        myThread = new TestSocket51();
        myThread.run();
    }
...
//                socket.setSoLinger(true, 0);
    ...
    private byte[] data(){
        byte[] b = new byte[169];
        System.arraycopy("51".getBytes(), 0, b, 0, 2);//消息类型
        System.arraycopy(bcdStringToByteArray(DateHelper.curentDateToYYYYMMDDHHMMSS()), 0, b, 2, 7);//消息生成时间
        System.arraycopy("012103154".getBytes(), 0, b, 9, 9);//当前bom代码
        System.arraycopy("0000000000000000".getBytes(), 0, b, 18, 16);//PSAM逻辑卡号
        ...
        System.arraycopy(bcdStringToByteArray("0200"), 0, b, 62, 2);//票卡类型
        System.arraycopy("8303201900000001    ".getBytes(), 0, b, 64, 20);//
        ...
        System.arraycopy(bcdStringToByteArray("20180706120703"), 0, b, 156, 7);//

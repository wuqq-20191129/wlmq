    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/frame/simple.css" title="Style"/>
            ...
            <body onload="initDocument('queryOp', '');
                    ...
                    setLinkText('queryOp','1','mainType#subType');"
            >
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">客流统计分析类报表--换乘客流年统计表
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="PflChangeYear">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="PflChangeYear"/>
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
                    ...
                    <td class="table_edit_tr_td_label">
                        ...
                        <c:set var="controlNames" scope="request" value="mainType#subType"/>
        ...
        <c:set var="note" scope="request" value="换乘客流年统计表"/>

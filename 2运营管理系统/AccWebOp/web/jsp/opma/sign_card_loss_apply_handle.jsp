<%--
    Document   : sign_card_loss_apply_handle
...
<body
	...
	<table class="table_title">
		<tr align="center" class="trTitle">
			<td colspan="4">退票退款管理 记名卡挂失申请处理</td>
		</tr>
	</table>
	...
	<form method="post" name="queryOp" id="queryOp"
		action="SignCardLossApplyHandle">
		<!-- 页面用到的变量 通用模板 -->
		<!--导出全部参数 -->
		<input type="hidden" name="expAllFields" id="q_expAllFields"
			value="BUSINESS_RECEIPT_ID,CARD_LOGICAL_ID,IDENTITY_TYPE,IDENTITY_ID,APPLY_NAME,TEL_NO,STATION_ID,APPLY_DATETIME,HDL_FLAG,AUDIT_FLAG,APPLY_DAYS" />
		<input type="hidden" name="expFileName" id="q_expFileName"
			value="记名卡挂失申请处理.xlsx" /> <input type="hidden" name="divId"
			id="q_divId" value="clearStartHead1" /> <input type="hidden"
			name="methodUrl" id="q_methodUrl"
			value="/SignCardLossApplyHandleExportAll" />
		...
		<table class="table_edit">
			...
			<tr class="table_edit_tr">
				...
				<td class="table_edit_tr_td_label">证件号码或<br>交易凭证号:
				</td>
				<td class="table_edit_tr_td_input"><input type="text"
					name="q_businessReceiptId" id="q_businessReceiptId" size="30"
					maxLength="25" require="false" dataType="NumAndEngAndMinus"
					msg="最大25位,仅能输入数字、字母和-(减号)" /></td>
			...
			<tr class="table_edit_tr">
				...
				<td class="table_edit_tr_td_label" rowspan="1"><c:import
					...
					<c:set var="export" scope="request" value="1" /> <c:set
						var="expAll" scope="request" value="1" /> <c:set
		...
		<div id="clearStartBlock1" class="divForTableBlock"
				...
				<table class="table_list_block" id="DataTableHead1">
					...
					<tr class="table_list_tr_head_block" id="ignore">
						...
						<td id="orderTd" style="width: 130px"
							...
							sortedby="asc" onclick="sortForTableBlock('clearStart1');">挂失申请卡号</td>
						<td id="orderTd" style="width: 80px"
							class="table_list_tr_col_head_block" isDigit=true index="2"
							sortedby="asc" onclick="sortForTableBlock('clearStart1');">证件类型</td>
						<td id="orderTd" style="width: 120px"
							class="table_list_tr_col_head_block" isDigit=true index="3"
							sortedby="asc" onclick="sortForTableBlock('clearStart1');">证件号码</td>
						<td id="orderTd" style="width: 80px"
						...
						<td id="orderTd" style="width: 60px"
							class="table_list_tr_col_head_block" isDigit=true index="10"
			...
			<div id="clearStart1" class="divForTableBlockData"
				style="height: 100px; overflow: auto; width: 1250px">
							...
							<c:choose>
								<c:when test="${rs.nonHandleFlag == '1'}">
									<td id="businessReceiptId" class="table_list_tr_col_data_block"
										style="width: 160px"><font color="red"> <b>${rs.businessReceiptId}</b></font></td>
									<td id="cardLogicalId" class="table_list_tr_col_data_block"
										style="width: 130px"><font color="red"> <b>${rs.cardLogicalId}</b></font></td>
									<td id="identityType" class="table_list_tr_col_data_block"
										style="width: 80px"><font color="red"> <b>${rs.identityTypeText}</b></font></td>
									<td id="identityId" class="table_list_tr_col_data_block"
										style="width: 120px"><font color="red"> <b>${rs.identityId}</b></font></td>
									<td id="applyName" class="table_list_tr_col_data_block"
										style="width: 80px"><font color="red"> <b>${rs.applyName}</b></font></td>
									<td id="telNo" class="table_list_tr_col_data_block"
										style="width: 100px"><font color="red"> <b>${rs.telNo}</b></font></td>
									<td id="stationId" class="table_list_tr_col_data_block"
										style="width: 80px"><font color="red"> <b>${rs.stationText}</b></font></td>
									<td id="applyDatetime" class="table_list_tr_col_data_block"
										style="width: 130px"><font color="red"> <b>${rs.applyDatetime}</b></font></td>
									<td id="hdlFlag" class="table_list_tr_col_data_block"
										style="width: 150px"><font color="red"> <b>${rs.hdlFlagText}</b></font></td>
									<td id="auditFlag" class="table_list_tr_col_data_block"
										style="width: 60px"><font color="red"> <b>${rs.auditFlagText}</b></font></td>
									<td id="applyDays" class="table_list_tr_col_data_block"
										style="width: 60px"><font color="red"> <b>${rs.applyDays}</b></font></td>
								</c:when>
								<c:when test="${rs.nonHandleFlag == '2'}">
									<td id="businessReceiptId" class="table_list_tr_col_data_block"
										style="width: 160px"><font color="fuchsia"> <b>${rs.businessReceiptId}</b></font></td>
									<td id="cardLogicalId" class="table_list_tr_col_data_block"
										style="width: 130px"><font color="fuchsia"> <b>${rs.cardLogicalId}</b></font></td>
									<td id="identityType" class="table_list_tr_col_data_block"
										style="width: 80px"><font color="fuchsia"> <b>${rs.identityTypeText}</b></font></td>
									<td id="identityId" class="table_list_tr_col_data_block"
										style="width: 120px"><font color="fuchsia"> <b>${rs.identityId}</b></font></td>
									<td id="applyName" class="table_list_tr_col_data_block"
										style="width: 80px"><font color="fuchsia"> <b>${rs.applyName}</b></font></td>
									<td id="telNo" class="table_list_tr_col_data_block"
										style="width: 100px"><font color="fuchsia"> <b>${rs.telNo}</b></font></td>
									<td id="stationId" class="table_list_tr_col_data_block"
										style="width: 80px"><font color="fuchsia"> <b>${rs.stationText}</b></font></td>
									<td id="applyDatetime" class="table_list_tr_col_data_block"
										style="width: 130px"><font color="fuchsia"> <b>${rs.applyDatetime}</b></font></td>
									<td id="hdlFlag" class="table_list_tr_col_data_block"
										style="width: 150px"><font color="fuchsia"> <b>${rs.hdlFlagText}</b></font></td>
									<td id="auditFlag" class="table_list_tr_col_data_block"
										style="width: 60px"><font color="fuchsia"> <b>${rs.auditFlagText}</b></font></td>
									<td id="applyDays" class="table_list_tr_col_data_block"
										style="width: 60px"><font color="fuchsia"> <b>${rs.applyDays}</b></font></td>
								</c:when>
								<c:otherwise>
									<td id="businessReceiptId" class="table_list_tr_col_data_block"
									...
									<td id="identityId" class="table_list_tr_col_data_block"
										style="width: 120px">${rs.identityId}</td>
									<td id="applyName" class="table_list_tr_col_data_block"
	...
	<c:set var="pTitleWidth" scope="request" value="1250" />
	<c:import
		url="/jsp/common/common_template.jsp?template_name=common_table_title" />
	<div id="clearStartBlock" class="divForTableBlock"
		style="height: 150px; ">
		<div id="clearStartHead" class="divForTableBlockHead" style="width: 1250px; ">
		...
		<div id="clearStart" class="divForTableBlockData"
			style="height: 100px;  width: 1250px;" >
	...
	<FORM method="post" name="detailOp" id="detailOp"
		...
		<input type="hidden" name="expAllFields" id="d_expAllFields"
			value="CARD_LOGICAL_ID,DEAL_DATETIME,DEAL_TYPE,LINE_ID,STATION_ID,DEVICE_ID,DEAL_FEE,DEAL_BALANCE_FEE,BALANCE_WATER_NO" />
		<input type="hidden" name="expFileName" id="d_expFileName"
			value="记名卡挂失申请历史记录.xlsx" /> <input type="hidden" name="divId"
			id="d_divId" value="clearStartHead" /> <input type="hidden"
			name="methodUrl" id="d_methodUrl"
			value="/SignCardLossApplyHandleHisExportAll" />

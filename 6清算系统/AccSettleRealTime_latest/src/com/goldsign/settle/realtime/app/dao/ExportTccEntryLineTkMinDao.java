 ...
 * @author hejj
 */
public class ExportTccEntryLineTkMinDao extends ExportTccBaseDao{
    private static Logger logger = Logger.getLogger(ExportTccEntryLineTkMinDao.class.getName());

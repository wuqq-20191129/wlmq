 ...
 * @author hejj
 */
public class FileWriter81C extends FileWriterBase {
    ...
    public String getLine(FileRecordBase vob) {
        ...
        sb.append(vo.getConsumeNum() + FileWriterBase.FIELD_DELIM);//扣费数量
        sb.append(this.convertFenToYuan(vo.getConsumeFee()) + FileWriterBase.FIELD_DELIM);//扣费金额

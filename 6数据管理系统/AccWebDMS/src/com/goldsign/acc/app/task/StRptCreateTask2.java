 ...
 */
public class StRptCreateTask2 extends BaskTask {

    private static Logger logger = Logger.getLogger(StRptCreateTask2.class);
    private String taskName;

    public StRptCreateTask2() {
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.OP_USER + "w_up_dm_st_rpt_create2", AppCodeConstant.TYPE_RESULT);

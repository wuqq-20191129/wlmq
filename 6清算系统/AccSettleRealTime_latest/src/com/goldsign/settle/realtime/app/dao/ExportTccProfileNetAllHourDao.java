 ...
 * @author hejj
 */
public class ExportTccProfileNetAllHourDao extends ExportTccBaseDao{
    private static Logger logger = Logger.getLogger(ExportTccProfileNetAllHourDao.class.getName());
    ...
    protected String getRecord(DbHelper dbHelper) throws Exception {
        ...
        sb.append(dbHelper.getItemValue("entry_station_id") + this.FIELD_DELIM);//断面起始站
        sb.append(dbHelper.getItemValue("exit_station_id") + this.FIELD_DELIM);//断终点站
        ...
        //最后字段
        sb.append(dbHelper.getItemValue("prof_num") );//断面客流量

 ...
 */
public class CmHisCreateTask extends BaskTask {

    private static Logger logger = Logger.getLogger(CmHisCreateTask.class);

    private String taskName;

    public CmHisCreateTask() {
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.CM_USER + "w_up_dm_cm_his_create", AppCodeConstant.TYPE_RESULT);

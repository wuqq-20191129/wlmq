 ...
 * @author goldsign
 */
public class TestSocket56 extends Thread{
...
//    public static final String ipAddress = "10.99.11.81";
    ...
    public static void main(String[] args) {
        TestSocket56 myThread;
        myThread = new TestSocket56();
        myThread.run();
    }
        ...
        try {
            ...
            for (int i=0; i<10; i++) {
                ...
                if(i==0){
                    ...
                    vo.setQrcode("08912BD798521FE2D9EF24DF12D1B46E8034E0B593B3A11D3830D9BA98F631D6");
                    sendData(data56(vo), out, i);
//                }else if(i==1){
//                }else if(i==2){
                }else{
                    sendQuery(out, i);
                ...
                if(dataType==3){
                    ...
                    sb.append(","+getCharString(data, 58, 11));//手机号
...
//                    socket.close();
    ...
    private byte[] data56(QrCodeVo vo){
        byte[] b = new byte[102];
        System.arraycopy("56".getBytes(), 0, b, 0, 2);//消息类型
        ...
        System.arraycopy(vo.getQrcode().getBytes(), 0, b, 38, 64);//密文数据
//        try {
//            System.arraycopy(RsaUtil.encrypt(vo.getQrcode().getBytes(), RsaUtil.publicKeyString), 0, b, 38, 64);//密文数据;
//        } catch (Exception ex) {
//            Logger.getLogger(TestSocket56.class.getName()).log(Level.SEVERE, null, ex);
//        }
        return b;
    }

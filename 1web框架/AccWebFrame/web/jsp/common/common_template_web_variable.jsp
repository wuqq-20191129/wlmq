...
<c:choose>
    ...
    <c:when test="${templateName == 'common_web_variable'}">
        ...
        <!-- 修改权限对应按钮-->
        <DIV id="priviModify" name="priviModify" value="btModify,btModify1,btSave,btSave1,btCancle,updateId" ></DIV>
        ...
        <!-- 定义所有功能按钮 -->
         ...
         <DIV id="functions" value="btClone,btAdd,btDelete,btModify,btModify1,btCheck,btSave,btSave1,btSubmit,btDetailSubmit,btSubmitSam,btUpdateId,btCancle,btPrint,btPrint1,btPrint2,btPrint3,btImport,btImport1,btExport,btExportBill,btExport1,btQuery,btDownload,btStatistic,btReportQuery,btCheck1,btDownload1,btDistribute,btRefundOk,btRefundNo,btRefundMd,btRefundCk,btAudit,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        ...
        <!-- 点击按钮时,可用的其他按钮 -->
        <!-- 点击克隆按钮时,可用的其他按钮 -->
        <DIV id="op_clone" avriable="btSave,btCancle,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击下发按钮时,可用的其他按钮 -->
        <DIV id="op_download" avriable="btDownload,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <DIV id="op_download1" avriable="btDownload1,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击统计按钮时,可用的其他按钮 -->
        <DIV id="op_statistic" avriable="btStatistic,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击报表查询按钮时,可用的其他按钮 -->
        <DIV id="op_reportQuery" avriable="btReportQuery,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击增加按钮时,可用的其他按钮 -->
        <DIV id="op_add" avriable="btSave,btCancle,btSave1" ></DIV>
        <!-- 点击删除按钮时,可用的其他按钮 -->
        <DIV id="op_del" avriable="btClone,btAdd,btDelete,btAudit,btCheck,btSubmit,btDetailSubmit,btSubmitSam,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击审核按钮时,可用的其他按钮 -->
        ...
        <!-- 点击导出按钮时,可用的其他按钮 -->
        <DIV id="op_export1" avriable="btExport1,btPrint1,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <DIV id="op_print1" avriable="btExport1,btPrint1,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <DIV id="op_print2" avriable="btExport1,btExport,btPrint2,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <DIV id="op_print3" avriable="btExport1,btExport,btPrint3,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击保存按钮时,可用的其他按钮 -->
        <DIV id="op_save" avriable="btClone,btAdd,btDelete,btAudit,btModify,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <DIV id="op_save1" avriable="btClone,btAdd,btDelete,btAudit,btModify,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>

        <DIV id="op_check1" avriable="btCheck1" ></DIV>

        <DIV id="op_version_draft" avriable="btAdd,btModify1,btCheck,btSubmit,btPrint,btExport,btExportBill,btQuery,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <DIV id="op_version_other" avriable="btClone,btQuery,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" ></DIV>
        <!-- 点击确认退款按钮时,可用的其他按钮 -->

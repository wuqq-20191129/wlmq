...
public class Encryption {
    ...
    private static final String EN_KEY = "GOLDSIGN";
     ...
     * @return
     */
    public static String biEncrypt(String aWord) {
        return biEncrypt(EN_KEY, aWord);
    }

    /**
     * 加密 biEncrypt(String aKey,String aWord) is a bi-directional encryption
     ...
     * @return
     */
    public static String biDecrypt(String aWord) {
        return biDecrypt(EN_KEY, aWord);
    }

    /**
     * 解密 biDecrypt(String aKey, String aWord) can decrypted the string which is

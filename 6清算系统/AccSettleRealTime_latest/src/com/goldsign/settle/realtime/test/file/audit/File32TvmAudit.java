 ...
 * @author hejj
 */
public class File32TvmAudit extends FileBase{
     public static void main(String[] arg) {
        File32TvmAudit ft = new File32TvmAudit();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="AUD0132."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0132", "20130810100000", "20130810100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        int[] data_type = {File52App.T_STR, File52App.T_BCD, File52App.T_STR, File52App.T_BCD, File52App.T_INT,
                           ...
                           File52App.T_INT, File52App.T_INT, File52App.T_INT, File52App.T_INT,File52App.T_INT,
                           File52App.T_STR, File52App.T_STR, File52App.T_BCD,File52App.T_INT, File52App.T_INT
                          };
        int[] data_len = {2,4, 9, 7, 2,
                          2, 4, 2, 2,4,
                          2,4,2,4,1,
                          2,2,2,4,4
                          
                          };
        Object[] datas = {"32", "20130810","020103001",this.getDealDatetime(), 1000,
                          1000, 200000, 500, 1000,200000,
                          10000,200000,100,50000,1,
                          "50","00","0100",1000,200000};
        /****************************************************************************************/
     ...
     public char[] getBufferCharFromLine() throws UnsupportedEncodingException {
        ...
        int[] data_len = {1,4, 9, 7, 2,
                          2, 4, 2, 2,4,
                          2,4,2,4,1,
                          2,2,2,4,4
                          
                          };
        Object[] datas = {"2", this.getCurrentDate(),"020103001",this.getStartTime(), 1000,
                          1000, 200000, 500, 1000,200000,
                          10000,200000,100,50000,1,
                          "50","00","0100",1000,200000};
        /****************************************************************************************/

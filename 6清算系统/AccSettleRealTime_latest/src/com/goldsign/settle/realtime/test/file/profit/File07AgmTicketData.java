 ...
 * @author hejj
 */
public class File07AgmTicketData extends FileBase{
     public static void main(String[] arg) {
        File07AgmTicketData ft = new File07AgmTicketData();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0107."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0107", "20130810100000", "20130810100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        int[] data_type = {File52App.T_BCD, File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_BCD,
                           File52App.T_INT,File52App.T_BCD, File52App.T_INT
                          };
        int[] data_len = {1, 9, 6,  16,7,
                          2,2, 2
                          
                          };
        Object[] datas = {"07", "020103001",  "000001", "1",this.getDealDatetime(), 
                           100,"0100", 500};
        /****************************************************************************************/
    ...
    public char[] getBufferCharForLine() throws UnsupportedEncodingException {
        ...
        int[] data_len = {1, 9, 6,  4,7,
                          2,2, 2
                          
                          };
        Object[] datas = {"07", "020103001",  "000001", 1,this.getStartTime(), 
                           100,"0100", 500};
        /****************************************************************************************/

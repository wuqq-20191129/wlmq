<%-- 
    Document   : ReportCTOut
    Created on : 2017-8-3, 11:05:30
    Author     : tdb
--%>
...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="票库出库"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_area_id#p_card_main_type#p_card_sub_type#p_out_reason_id#p_begin_day#p_end_day"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_area_id#p_card_main_type#p_card_sub_type#p_out_reason_id#p_begin_day#p_end_day#bufferFlag"/>
            ...
            <table class="table_edit">
                ...
                <tr class="table_edit_tr">
                    <!--出库原因-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_out_reason_id" />
                ...
                <tr class="table_edit_tr">
                    ...
                    <td colspan="7">
                        <div align="left">查询条件的日期为出库单的审核日期</div>
                    </td>
                </tr>
            </table>
        </form>

...
public class LccAct extends BaseAction {
    ...
    public ActionMessage query(HttpServletRequest request, LccDao pmb, Vector statues, String command) throws Exception {

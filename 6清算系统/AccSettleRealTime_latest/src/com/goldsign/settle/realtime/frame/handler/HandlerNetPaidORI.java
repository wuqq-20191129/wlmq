 ...
 * @author hejj
 */
public class HandlerNetPaidORI extends HandlerBase{
    private static Logger logger = Logger.getLogger(HandlerNetPaidORI.class.getName());
    @Override
    ...
    private void parseFileName(String fileName) throws FileNameException {
        ...
        util.parseLen(fileName, FileNameParseUtil.FILE_LEN_ORI);
        util.parseFmtForOneOnlyLine(fileName, FileNameParseUtil.FILE_START_ORI);

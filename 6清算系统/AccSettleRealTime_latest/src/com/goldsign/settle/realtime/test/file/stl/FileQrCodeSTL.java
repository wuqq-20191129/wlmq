 ...
 * @author hejj
 */
public class FileQrCodeSTL extends FileBase {

    public static void main(String[] arg) {
        FileQrCodeSTL ft = new FileQrCodeSTL();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "STL70." + ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"70", this.getStartTime(), this.getEndTime(), 1};
        /**
         * ******************************************
         */
        /**

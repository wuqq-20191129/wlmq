...
//    public static final String ipAddress = "127.0.0.1";
    ...
    public static void main(String[] args) {
        TestSocket32 myThread;
        myThread = new TestSocket32();
        myThread.run();
    }
...
//                }else if(i==2){
                ...
                if(dataType==3){
                    ...
                    sb.append(","+getCharString(data, 62, 8));//
                    sb.append(","+getBcdString(data, 70, 7));//
                    sb.append(","+getCharString(data, 77, 2));//
                    sb.append(","+getCharString(data, 79, 2));//
...
//                socket.setSoLinger(true, 0);
    ...
    private byte[] data(){
        byte[] b = new byte[186];
        System.arraycopy("32".getBytes(), 0, b, 0, 2);//消息类型
        System.arraycopy(bcdStringToByteArray(DateHelper.curentDateToYYYYMMDDHHMMSS()), 0, b, 2, 7);//消息生成时间
        System.arraycopy("810015000".getBytes(), 0, b, 9, 9);//当前bom代码
        ...
        System.arraycopy("8303801900000001    ".getBytes(), 0, b, 64, 20);//
        ...
        System.arraycopy(longStringToByteArray(1000L,4), 0, b, 116, 4);//
        System.arraycopy(longStringToByteArray(20000L,4), 0, b, 120, 4);//
        System.arraycopy("00000000".getBytes(), 0, b, 124, 8);//
        System.arraycopy("00000000".getBytes(), 0, b, 132, 8);//
        System.arraycopy("0000000000000000".getBytes(), 0, b, 140, 16);//
        System.arraycopy(bcdStringToByteArray("20180706121403"), 0, b, 156, 7);//
        System.arraycopy("000000".getBytes(), 0, b, 163, 6);//
        System.arraycopy("13411000004".getBytes(), 0, b, 169, 11);//
        System.arraycopy("01".getBytes(), 0, b, 180, 2);//
        System.arraycopy("0000".getBytes(), 0, b, 182, 4);//

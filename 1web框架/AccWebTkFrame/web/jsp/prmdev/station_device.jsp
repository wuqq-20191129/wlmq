        ...
        <form method="post" name="queryOp" id="queryOp" action="StationDevice">
            ...
            <table  class="table_edit">
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_input">
                        <input type="text" name="q_deviceID" id="q_deviceID" size="10"  maxLength="3" require="false" dataType="LimitB" min="3" max="3" msg="设备ID应为3位"/>
                    </td>    

                    <td class="table_edit_tr_td_label">设备序列号:</td>
                    <td class="table_edit_tr_td_input">
                        <input type="text" name="q_deviceSerial" id="q_deviceSerial" size="10"/>                     
                    </td>
            ...
            <div id="clearStartHead" class="divForTableBlockHead">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="6"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >闸机所属的阵列编号</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="9"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >设备IP地址</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="11" sortedby="asc"  onclick="sortForTableBlock('clearStart');">配置时间</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="13" sortedby="asc"  onclick="sortForTableBlock('clearStart');">版本号</td>
                    </tr>
                ...
                <table class="table_list_block" id="DataTable" >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            <td  id="IPAddress" class="table_list_tr_col_data_block">
                                ${rs.ip_address}
                            </td>
                            <td  id="venderID" class="table_list_tr_col_data_block">
                                ${rs.store_id_name}
                            </td>
                            <td  id="configDate" class="table_list_tr_col_data_block">
                                ${rs.config_date}
                            </td>
                            <td  id="devName" class="table_list_tr_col_data_block">
                                ${rs.dev_name}
                            </td>
                            <td  id="versionNo" class="table_list_tr_col_data_block" >
                                ${rs.version_no}
                            </td>
            ...
            <DIV id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    <tr class="table_edit_tr">
                        <td class="table_edit_tr_td_label">线路: </td>
                        <td class="table_edit_tr_td_input">
                            <select  name="d_lineID"  id="d_lineID" onChange="setSelectValues('detailOp', 'd_lineID', 'd_stationID', 'commonVariable');" require="true" dataType="LimitB" min="1" msg="没有选择线路">
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_line" />
                            </select>	
                        </td>
                        <td class="table_edit_tr_td_label">车站:</td>
                        <td class="table_edit_tr_td_input">
                            <select id="d_stationID" name="d_stationID" require="true" dataType="LimitB" min="1" msg="没有选择车站">
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_none" />
                        ...
                        <td class="table_edit_tr_td_label">设备ID:</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_deviceID" id="d_deviceID" size="10" maxLength="3" dataType="integer|LimitB|NotEmpty" min="3" max="3" msg="设备ID应为3位数字！"/>
                        </td>
                    </tr>
                    ...
                    <tr class="table_edit_tr">
                        <td class="table_edit_tr_td_label">设备类型: </td>
                        <td class="table_edit_tr_td_input">
                            <select id="d_deviceType" name="d_deviceType" require="true" dataType="LimitB" min="1" msg="没有选择设备类型">
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_devtype" />
                            </select>	
                        </td>
                        <td class="table_edit_tr_td_label">闸机所属的阵列编号:</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_arrayID" id="d_arrayID" size="10" require="true" maxLength="3" dataType="Number|LimitB" min="3" max="3" msg="闸机所属的阵列编号应为3位数字"/>
                        </td>
                        <td class="table_edit_tr_td_label">设备CSC读写器数量:</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_CSCNumber"  id="d_CSCNumber" size="10" require="true" maxlength="3" dataType="integer"  value="0" msg="设备CSC读写器数量应为正整数"/>
                        </td>
                    </tr>
                    <tr class="table_edit_tr">
                        <td class="table_edit_tr_td_label">车站内区域编号:</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_zoneID" id="d_zoneID" size="10" maxLength="3" require="true" dataType="Number|LimitB" min="3" max="3" msg="车站内区域编号应为3位数字"/>
                        </td>
                        <td class="table_edit_tr_td_label">设备序列号:</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_deviceSerial" id="d_deviceSerial" size="10" maxLength="20" require="true" dataType="NotEmpty"  msg="设备序列号不能为空" />
                        </td>
                        <td class="table_edit_tr_td_label">设备IP地址:</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_IPAddress" id="d_IPAddress" size="10" maxLength="15" require="true" dataType="IPAddress"   msg="设备IP地址格式不正确!" />
                        </td>
                    </tr>
                    <tr class="table_edit_tr">
                        <td class="table_edit_tr_td_label">商户ID:</td>
                        <td class="table_edit_tr_td_input">
                            <select id="d_venderID" name="d_venderID" require="true" dataType="LimitB" min="1" msg="商户ID应为5位数字">
                        ...
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_configDate" id="d_configDate" size="10"  dataType="ICCSDate"  msg="配置日期格式为[****-**-**]"/>
                        ...
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_devName" id="d_devName" size="10" require="true"  maxLength="30"  dataType="NotEmpty" value=""  msg="设备名称不能为空" />
                        </td>
                    </tr>

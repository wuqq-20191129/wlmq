<%-- 
    Document   : TicketStorageInCancelInBillDetial
    Created on : 2017-8-7
    Author     : luck
--%>
        ...
        <form method="post" name="detailOp" id="detailOp" action="ticketStorageInCheckManage" >
            ...
            <div id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    ...
                    <td class="table_edit_tr_td_input">
                        <input type="text" name="d_real_balance" id="d_real_balance" size="8"  maxlength="9" dataType="integer|Limit" required="true" value="0"   msg="实际结余票数量为正整数"/>
                    </td>

                    <td class="table_edit_tr_td_label">注销多票:</td>
                    <td class="table_edit_tr_td_input">
                        <input type="text" name="d_cancel_more_num" id="d_cancel_more_num" size="8"  maxlength="9" dataType="integer|Limit" required="true" value="0"   msg="注销多票数量为正整数"/>
                    </td>
                    </tr>
            ...
            <c:set var="clickMethod" scope="request" value="addCheckNum('detailOp',['d_valid_num','d_man_useless_num','d_real_balance','d_cancel_more_num'])"/>
            <c:set var="addAfterMethod" scope="request" value="disableFormControls('detailOp',['d_billNo'],true);"/>
            <c:set var="exportBillAfter" scope="request" value="exportBillDetail('detailOp','w_rpt_ic_rct_bl_in_cr',['p_bill_no'],['queryCondition'],800,500)"/>

...
public class AnalyzeVo {
    ...
    /**
     * @param cEndExpire the cEndExpire to set
     */
    ...
    public String toString() {
        return "AnalyzeVo{" + "bIssueStatus=" + bIssueStatus + ", bStatus=" + bStatus + ", cTicketType=" + cTicketType + ", cLogicalID=" + cLogicalID + ", cPhysicalID=" + cPhysicalID + ", bCharacter=" + bCharacter + ", cIssueDate=" + cIssueDate + ", cEndExpire=" + cEndExpire + ", rfu=" + rfu + ", lBalance=" + lBalance + ", lDeposite=" + lDeposite + ", cLine=" + cLine + ", cStationNo=" + cStationNo + ", cDateStart=" + cDateStart + ", cDateEnd=" + cDateEnd + ", dtDaliyActive=" + dtDaliyActive + ", bEffectDay=" + bEffectDay + ", cLimitEntryLine=" + cLimitEntryLine + ", cLimitEntryStation=" + cLimitEntryStation + ", cLimitExitLine=" + cLimitExitLine + ", cLimitExitStation=" + cLimitExitStation + ", cLimitMode=" + cLimitMode + ", certificateIscompany=" + certificateIscompany + ", certificateIsmetro=" + certificateIsmetro + ", certificateName=" + certificateName + ", certificateCode=" + certificateCode + ", certificateType=" + certificateType + ", certificateSex=" + certificateSex + ", tradeCount=" + tradeCount + '}';
    }

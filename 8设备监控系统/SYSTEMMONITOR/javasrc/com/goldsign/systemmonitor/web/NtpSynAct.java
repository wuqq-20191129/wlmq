...
public class NtpSynAct extends BaseAction {
    ...
    public ActionMessage query(HttpServletRequest request, NtpSynDao pmb, Vector statues, String command) throws Exception {

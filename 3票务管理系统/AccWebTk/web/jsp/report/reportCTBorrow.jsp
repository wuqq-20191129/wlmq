...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="借票统计"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_area_id#p_card_main_type#p_card_sub_type#p_borrow_unit_id#p_return_flag#p_begin_day#p_end_day"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_area_id#p_card_main_type#p_card_sub_type#p_borrow_unit_id#p_return_flag#p_begin_day#p_end_day#bufferFlag"/>
            ...
            <table class="table_edit">
                ...
                <tr class="table_edit_tr">
                    <!--借票单位-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_borrow_unit_id" />
                    
                    <!--是否归还-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_return_flag" />
                ...
                <tr class="table_edit_tr">
                   <!--取上次查询生成的报表-->
                    ...
                    <td class="table_edit_tr_td_label">
                      ...
                      <%--<c:set var="addClickMethod" scope="request" value="setControlNames('queryOp','p_storage#p_storageZone#p_cardMainCode#p_cardSubCode#p_borrowUnitId#p_returnFlag#p_begin_day#p_end_day#p_bufferFlag');--%>
                ...
                <tr class="table_edit_tr">
                    ...
                    <td colspan="7">
                        <div align="left">查询条件的日期为车票借出单的审核日期</div>
                    </td>
                </tr>
            </table>
        </form>

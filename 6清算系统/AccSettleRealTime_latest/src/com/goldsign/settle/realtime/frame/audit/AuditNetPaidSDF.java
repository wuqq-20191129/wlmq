...
import com.goldsign.settle.realtime.frame.dao.FileNetPaidLccDao;
 ...
 * @author hejj
 */
public class AuditNetPaidSDF extends AuditBase{
    ...
    private int[] dataType = {FileGenericBase.T_STR, FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT
                                                           
    };
    private int[] dataLen = {4, 4, 4, 4, 4
                              
                              };

    
    public Vector<String> genAuditFiles(String balanceWaterNo) throws Exception {
        FileNetPaidLccDao dao = new FileNetPaidLccDao();
        //从数据库中获取记录，记录按线路分开
        ...
        */
        ...
        Vector<String> fileNames = this.writeDataToFilesForGenericNetPaid_3(records, balanceWaterNo, AuditER.DATA_TYPE_SDF, 
                                                          dataTypeHead,dataLenHead,dataType,dataLen,
                                                          dataTypeTail,dataLenTail,FrameCodeConstant.PATH_FILE_AUDIT_LCC,
                                                          FrameCodeConstant.LINE_ID_NETPAID);
        return fileNames;
    }

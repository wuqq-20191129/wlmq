 ...
 * @author hejj
 */
public class File53App extends FileBase {

    public static String serialNo = "053";

    public static void main(String[] arg) {
        File53App ft = new File53App();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0110." + ft.getCurrentDate() + "." + File53App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] datas = {
            "53", "12", "0102", "04", "001",
            "000000008A654672", 100, "0600", "0101011234567010", "8A563201",
            this.getDealDatetime(), 108, 9800, "0", "000",
            "0000", "0000", "0", 100, "1",
            this.getDealDatetime(),"201912",2000,180,this.getDealDatetime(),
            10

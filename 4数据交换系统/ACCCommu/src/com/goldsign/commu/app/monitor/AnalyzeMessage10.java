 ...
 * @author zhangjh
 */
public class AnalyzeMessage10 extends com.goldsign.commu.frame.message.AnalyzeMessageBase {
	private static Logger logger = Logger.getLogger(AnalyzeMessage10.class
			.getName());

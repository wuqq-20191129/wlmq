 ...
 * @author hejj
 */
public class File76App extends FileBase{
    public static String serialNo = "076";

    public static void main(String[] arg) {
        File76App ft = new File76App();
        //  String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0110." + ft.getCurrentDate() + "." + File76App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] datas = {
            "76", "11", "0103", "03", "001",
            "8300000302A00001", 100, "1100", "8300C10300000001", "8A563201",

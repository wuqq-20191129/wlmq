...
public class TicketStorageStListSignCard implements Serializable {
    ...
    private String strAppDateTime;

    public String getStrAppDateTime() {
        return strAppDateTime;
    }

    public void setStrAppDateTime(String strAppDateTime) {
        this.strAppDateTime = strAppDateTime;
    }
    ...
    public TicketStorageStListSignCard() {
        super();
    }
    ...
    public boolean equals(Object that) {
        ...
        TicketStorageStListSignCard other = (TicketStorageStListSignCard) that;

 ...
 * @author hejj
 */
public class HandlerMobileSTL extends HandlerBase{
     private static Logger logger = Logger.getLogger(HandlerMobileSTL.class.getName());
    ...
    public void handleMessage(MessageBase msg) {
     ...
     private String getTradType(FileNameSection fileNameSect) throws Exception {
         return CLASS_PARSER_SHORT_NAME_MOBILE +fileNameSect.getTradType();

...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="持有量统计"/>
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <table class="table_edit">
                <tr class="table_edit_tr">
                    ...
                    <!--票卡主类型-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_card_main_type_default" />
                    <!--票卡子类型-->

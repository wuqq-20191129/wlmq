 ...
 * 纸币找零箱存入
 */
public class File09NotePut extends FileBase{
    public static void main(String[] arg) {
        File09NotePut ft = new File09NotePut();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0109."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0109", "20131106100000", "20131106100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"09", "020102001", 1,"1", "000001", 
            this.getDealDatetime(),  100, 200, 100, 2000};
        /****************************************************************************************/

...
import com.goldsign.settle.realtime.frame.dao.FileQrCodeLccDao;
import com.goldsign.settle.realtime.frame.dao.FileQrCodeMtrLccDao;
 ...
 * @author mh
 */
public class AuditQrCodeMtrSDF extends AuditBase{
    ...
    private int[] dataType = {FileGenericBase.T_STR, FileGenericBase.T_STR, FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT,
        FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT,
        FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT, FileGenericBase.T_INT,FileGenericBase.T_STR
    };
    private int[] dataLen = {2, 4, 4, 4, 4,
        4, 4, 4, 4, 4,
        4, 4, 4, 4,2
    ...
    public Vector<String> genAuditFiles(String balanceWaterNo) throws Exception {
        FileQrCodeMtrLccDao dao = new FileQrCodeMtrLccDao();
        //从数据库中获取记录，记录按线路分开

 ...
 * @author hejj
 */
public class File59App extends FileBase {

    public static String serialNo = "059";

    public static void main(String[] arg) {
        File59App ft = new File59App();
        //    String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0107." + ft.getCurrentDate() + "." + serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0107", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 1};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {
            "59", "10", "0107", "04", "001", 
            "8300000302E00001",100, "0600", "00000000000011138291", "4CDE4368",
            120,"1", this.getDealDatetime(), "999999", "01",
            "0","2"

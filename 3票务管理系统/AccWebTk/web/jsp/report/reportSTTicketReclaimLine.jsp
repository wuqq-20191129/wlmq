<%-- 
    Document   : reportSTLineDistributes
    Created on : 2017-8-8, 20:35:44
    Author     : xiaowu
--%>
...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="回收量线路汇总"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_line_id#p_card_main_type#p_card_sub_type#p_bill_no#p_begin_day#p_end_day"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_line_id#p_card_main_type#p_card_sub_type#p_bill_no#p_begin_day#p_end_day#bufferFlag"/>
            ...
            <table class="table_edit">
                ...
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_input">
                        <input name="p_bill_no" id="p_bill_no"  size="12" maxlength="12" />
                    </td>

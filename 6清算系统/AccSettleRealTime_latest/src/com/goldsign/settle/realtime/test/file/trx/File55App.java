 ...
 * @author hejj
 */
public class File55App extends FileBase{
    public static String serialNo = "055";

    public static void main(String[] arg) {
        File55App ft = new File55App();
    //    String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0108." + ft.getCurrentDate() + "." + serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0108", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 1};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {
            "55","10", "0108", "04", "001", 
            "8300000302E00001",100, "0201", "83000000000011138291", "4CDE4368",
            120,this.getDealDatetime(), this.getDealDatetime(), this.getDealDatetime(),"999999",
            "01", "0"

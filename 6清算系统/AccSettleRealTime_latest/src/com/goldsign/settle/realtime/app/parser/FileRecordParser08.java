 ...
 * 12.8. TVM废票箱数据
 */
public class FileRecordParser08 extends FileRecordParserBase {

    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecord08 r = new FileRecord08();
    ...
    private FileRecord00DetailResult getInfoForCommon(FileRecord08 r, char[] b, int offset) throws Exception {
    ...
    private FileRecord00DetailResult getInfoForOther(FileRecord08 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

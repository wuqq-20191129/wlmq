 ...
 * @author hejj
 */
public class File04CoinClear extends FileBase {

    public static void main(String[] arg) {
        File04CoinClear ft = new File04CoinClear();
        //String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "PRO0104." + ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0104", "20131106100000", "20131106100059", 1};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {"04", "020102001", "000001", "1", this.getDealDatetime(),
            1, 50, 100, 100, 100,
            8,
            10000, 10000,
            0, 0,
    ...
    public char[] getBufferCharForLine() throws UnsupportedEncodingException {
        ...
        Object[] datas = {"04", "020102001", "000001", 1, this.getStartTime(),
            1, 50, 100, 100, 100,
            10000, 10000, 0, 0, 0,
            0, 0, 100, 100, 0,
            0, 0, 0, 0, 0,

...
import com.goldsign.settle.realtime.app.dao.ExportTccEntryStationTkMinDao;
 ...
 * @author hejj
 */
public class TccEntryStationTkMin extends FileTccBase{
     private static Logger logger = Logger.getLogger(TccEntryStationAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟车站分票种进站量";
     private static String PROCEDURE_NAME="w_up_st_tcc_EntryStationTkMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccEntryStationTkMinDao dao = new ExportTccEntryStationTkMinDao();

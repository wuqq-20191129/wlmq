...
<html>
    ...
    <head>
        ...
        <title>::乌市轨道交通自动售检票系统--设备监控平台系统::</title>
    ...
    <body>
        <div class="header header-bg">
            <div class="header-logo"><img src="././images/logo/logo.png"/></div>
            <div class="header-title"><img src="././images/logo/title.png" width="244" height="36"/></div>

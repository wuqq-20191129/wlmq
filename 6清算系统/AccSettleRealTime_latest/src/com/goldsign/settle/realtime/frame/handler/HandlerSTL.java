 ...
 * @author hejj
 */
public class HandlerSTL extends HandlerBase{
    private static Logger logger = Logger.getLogger(HandlerSTL.class.getName());
    ...
    public void handleMessage(MessageBase msg) {
     ...
     private FileData parseFile(String path, String fileName, String balanceWaterNo,int balanceWaterNoSub) throws RecordParseForFileException, RecordParseHeadForFileException {
     ...
     private String getTradType(FileNameSection fileNameSect) throws Exception {
         return fileNameSect.getTradType();

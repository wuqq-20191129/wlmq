...
var d1 =new Date(op1.substr(0,4),op1.substr(5,2),op1.substr(8,2));
var d2 =new Date(op2.substr(0,4),op2.substr(5,2),op2.substr(8,2));
//alert(op1.substr(0,4)+":"+op1.substr(5,2)+":"+op1.substr(8,2));
var ms1=d1.getTime();
//alert(ms1);
var ms2=d2.getTime()+(num*24*3600*1000);
//alert(ms2);

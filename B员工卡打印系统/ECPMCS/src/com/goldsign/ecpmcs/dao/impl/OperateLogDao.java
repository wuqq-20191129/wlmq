...
public class OperateLogDao extends BaseDao implements IOperateLogDao{
    ...
    public List<OperateLogVo> getOperaterLogs(OperateLogParam operateLogParam) {
        ...
        try {
            ...
            String sqlStr = "select * from "+AppConstant.DATABASE_USER_TK+"W_IC_ECP_OPRTLOG ";
    ...
    public void insertOperaterLogs(OperateLogVo vo) {
        ...
        try {
            ...
            String sqlStr = "INSERT INTO "+AppConstant.DATABASE_USER_TK+"W_IC_ECP_OPRTLOG (water_no, oper_id, oprt_time, oprt_content, oprt_result)"
                            + "VALUES ("+AppConstant.DATABASE_USER_TK+"W_SEQ_W_IC_ECP_OPRTLOG.nextval, ?, SYSDATE, ?, ?)";

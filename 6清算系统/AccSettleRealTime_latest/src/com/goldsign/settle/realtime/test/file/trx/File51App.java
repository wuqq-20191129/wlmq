 ...
 * @author hejj
 */
public class File51App extends FileBase{
    public static String serialNo = "051";

    public static void main(String[] arg) {
        File51App ft = new File51App();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0105." + ft.getCurrentDate() + "." + File51App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] datas = {
            ...
            "000000000000",0, "00", 0, this.getDealDatetime(), 
            "0000","000000", "00", 0,"0", 
            "13588888888",200
        };
        Object[] datas_1 = {

 ...
 * @author mh
 */
public class FileQrCodeMtrLccDao {
    ...
    public Hashtable<String, Vector> getRecordsForAudit(String balanceWaterNo) throws Exception {
        ...
        Object[] values = {balanceWaterNo,FrameCodeConstant.ISSUE_QRCODE_PLATFORM_MTR};
        FileQrCodeSDFVo vo;
        try {
    ...
    private void addRecord(Hashtable<String, Vector> ht, FileQrCodeSDFVo vo) {
        String lineDate = FrameCodeConstant.LINE_ID_QRCODE_MTR + "#" + vo.getSquadDay();//add by hejj 20200706

 ...
 * @author hejj
 */
public class FileOctSeqDao {
     private static Logger logger = Logger.getLogger(FileOctSeqDao.class.getName());

    public ResultFromProc getFileOctSeq(String balanceWaterNo) throws Exception {

        String sql = "{call "+FrameDBConstant.DB_PRE+"up_st_sys_get_oct_file_seq(?,?,?,?)} ";//存储过程调用语句

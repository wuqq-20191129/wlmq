 ...
 */
//预制票售票记录
public class FileWriter63 extends FileWriterBase{
     @Override
    ...
    public String getLine(FileRecordBase vob) {
        FileRecord63 vo =(FileRecord63)vob;
        ...
        sb.append(this.convertFenToYuan(vo.getDepositFee()) + FileWriterBase.FIELD_DELIM);//押金
        sb.append(this.convertFenToYuan(vo.getBalanceFee()) + FileWriterBase.FIELD_DELIM);//余额

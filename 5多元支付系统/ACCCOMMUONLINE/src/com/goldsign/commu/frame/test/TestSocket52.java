 ...
 * @author goldsign
 */
public class TestSocket52 extends Thread{
...
//    public static final String ipAddress = "127.0.0.1";
    ...
    public static void main(String[] args) {
        TestSocket52 myThread;
        myThread = new TestSocket52();
        myThread.run();
    }
...
//                    socket.close();
    ...
    private byte[] data(){
        byte[] b = new byte[150];
        System.arraycopy("52".getBytes(), 0, b, 0, 2);//消息类型
        ...
        System.arraycopy(longStringToByteArray(141L,4), 0, b, 139, 4);//
        System.arraycopy(bcdStringToByteArray("20180706121855"), 0, b, 143, 7);//

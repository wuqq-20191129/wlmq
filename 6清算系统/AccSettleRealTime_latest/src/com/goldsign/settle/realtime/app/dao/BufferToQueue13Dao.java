 ...
 * @author hejj
 */
public class BufferToQueue13Dao extends BufferToQueueBaseDao{

    @Override
    public ResultFromProc bufToQueue(String balanceWaterNo,int balanceWaterNoSub, String fileName) throws Exception {
         return this.bufToQueueCommon(balanceWaterNo,balanceWaterNoSub, fileName, "up_st_trf_pbtoq_tvm_bal");
    }

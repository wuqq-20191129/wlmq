 ...
 * @author hejj
 */
public class HandlerTrxQrCode extends HandlerTrxBase{
     private static Logger logger = Logger.getLogger(HandlerTrxQrCode.class.getName());
    ...
    private void parseFileName(String fileName,String balanceWaterNo) throws FileNameException {
        ...
        util.parseFmtForTwo(fileName, FileNameParseUtil.FILE_START_TRX_QRCODES);
    ...
    private String getTradType(String line) throws Exception {
        ...
        String trdType = CLASS_PARSER_SHORT_NAME_QRCODE + this.getCharString(b, 0, 2);
        return trdType;
    }

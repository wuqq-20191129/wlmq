...
import com.goldsign.settle.realtime.app.dao.ExportTccExitLineAllMinDao;
 ...
 * @author hejj
 */
public class TccExitLineAllMin extends FileTccBase {

    private static Logger logger = Logger.getLogger(TccEntryLineAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟线路出站量";
    private static String PROCEDURE_NAME = "w_up_st_tcc_ExitLineAllMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccExitLineAllMinDao dao = new ExportTccExitLineAllMinDao();

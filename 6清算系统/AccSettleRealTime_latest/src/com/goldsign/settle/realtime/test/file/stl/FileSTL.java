 ...
 * @author hejj
 */
public class FileSTL extends FileBase {

    public static void main(String[] arg) {
        FileSTL ft = new FileSTL();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "STL01." + "20200102";//ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"01", this.getStartTime(), this.getEndTime(), 1};
        /**
         * ******************************************
         */
        /**
         ...
         * *****************lcc对账数据*************
         */
        int[] data_type = {File52App.T_STR,
            File52App.T_STR, File52App.T_INT, File52App.T_INT, File52App.T_INT, File52App.T_INT,
        ...
        Object[] datas = {"13",
            "0101", 100, 20000, 110, 22000,
            10, 20000, 100000, 1, 10000,
            10, 2000, 1, 2000, 3000,
            0, 0, 1000, 200000, 10,
            3000, 0, 0, 10, 1000,
            2500, 10, 2000, 1, 5000,

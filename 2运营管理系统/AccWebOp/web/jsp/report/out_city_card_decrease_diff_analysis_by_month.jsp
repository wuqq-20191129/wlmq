    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/frame/simple.css" title="Style"/>
            ...
            <body onload="initDocument('queryOp', '');
                    ...
                    setLinkText('queryOp','3','');"
            >
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">外部清算类报表--一卡通清分结果差异统计日报表—扣值
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="OutCityCardDecreaseDiffAnalysisByMonth">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="OutCityCardDecreaseDiffAnalysisByMonth"/>
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
        ...
        <c:set var="note" scope="request" value="一卡通清分结果差异统计日报表—扣值"/>

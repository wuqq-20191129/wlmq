 ...
 * @author hejj
 */
public class FileQrCode54App extends FileBase {

    public static String serialNo = "054";

    public static void main(String[] arg) {
        FileQrCode54App ft = new FileQrCode54App();
        // String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX7000." + ft.getCurrentDate() + "." + File54App.serialNo;
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"7000", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 2};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {
            "54", "11", "0101", "04", "001",
            "000000008A654672", 100, this.getDealDatetime(), "1241", "8303801102000001",

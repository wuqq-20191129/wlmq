 ...
 * @author hejj
 */
public class File83RegData extends FileBase {

    public static void main(String[] arg) {
        File83RegData ft = new File83RegData();
        //  String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "REG0183." + ft.getCurrentDate();;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0183", this.getStartTime(), this.getEndTime(), 1};
        /**
         * ******************************************
         */
        /**
        ...
        int[] data_type = {File52App.T_STR, File52App.T_BCD, File52App.T_STR, File52App.T_STR, File52App.T_STR,
            ...
            File52App.T_INT, File52App.T_INT, File52App.T_INT, File52App.T_BCD, File52App.T_INT,
            File52App.T_INT, File52App.T_INT, File52App.T_BCD, File52App.T_INT, File52App.T_INT,
            File52App.T_INT, File52App.T_BCD, File52App.T_BCD, File52App.T_INT, File52App.T_INT,
            File52App.T_INT, File52App.T_BCD, File52App.T_INT, File52App.T_INT, File52App.T_INT,
            File52App.T_BCD,File52App.T_INT, File52App.T_INT
        ...
        Object[] datas = {"83", this.getDealDatetime(), "0201", "04", "001",
            this.getDealDatetime(), 0, 1, 200, 1,
            2, 200, 1, "0200", 1,
            200, 1, "0200", 1, 10000,
            1, "0200", "01", 3, 200,
            1, "0200", 1, 100, 1,

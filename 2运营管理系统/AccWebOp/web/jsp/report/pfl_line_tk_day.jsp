    ...
    <head>
        ...
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">客流统计分析类报表--线路票种客流分析日报
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="PflLineTkDay">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="PflLineTkDay"/>
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
        ...
        <c:set var="note" scope="request" value="线路票种客流分析日报"/>

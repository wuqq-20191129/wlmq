...
<html>
    ...
    <body onload="initDocument('queryOp', 'detail');
            ...
            setPrimaryKeys('detailOp', 'd_beginLogicalId#d_endLogicalId');
        ...
        <form method="post" name="queryOp" id="queryOp" action="BlackListMtrSec">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <table  class="table_edit">
                ...
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_label" rowspan="2">
                        ...
                        <%--<c:set var = "checkCon!== 0)ditionMethod" scope="request" value = "checkCondition('queryOp');"/>--%>
            ...
            <div id="clearStartHead" class="divForTableBlockHead">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    style="width: 120px" class="table_list_tr_col_head_block"  isDigit=true index="1"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >开始逻辑卡号</td>
                        <td id="orderTd"    style="width: 120px" class="table_list_tr_col_head_block"  isDigit=true index="2"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >结束逻辑卡号</td>
                        <td id="orderTd"    style="width: 120px" class="table_list_tr_col_head_block"  isDigit=false index="3"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >产生时间</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="4"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >产生原因</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >操作员代码</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="6"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >生效时间</td>
                        <td id="orderTd"    style="width: 120px" class="table_list_tr_col_head_block"  isDigit=false index="7"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >设备处理标志</td>
                        <td id="orderTd"    style="width: 250px" class="table_list_tr_col_head_block"  isDigit=false index="8"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >备注</td>
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);"
                            ...
                            <td id="rectNo1" class="table_list_tr_col_data_block">
                                <input type="checkbox" name="rectNo" onclick="unSelectAllRecord('detailOp', 'rectNoAll', 'rectNo');"
                                       value="${rs.beginLogicalId}#${rs.endLogicalId}">
                                </input>
                            </td>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="BlackListMtrSec">
            <c:set var="divideShow" scope="request" value="1"/>
            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
            <!--导出全部参数 -->
<!--             <input type="hidden" name="expAllFields" id="d_expAllFields" value="BEGIN_LOGICAL_ID,END_LOGICAL_ID,CREATE_DATETIME,BLACK_TYPE,OPERATOR_ID,GEN_DATETIME,ACTION_TYPE,REMARK" /> -->
			...
			<input type="hidden" name="expFileName" id="d_expFileName" value="地铁黑名单段.xlsx" />
			<input type="hidden" name="divId" id="d_divId" value="clearStartHead" />
			<input type="hidden" name="methodUrl" id="d_methodUrl" value="/BlackListMtrSecExportAll" />
            <DIV id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    <tr class="table_edit_tr">
                        <td class="table_edit_tr_td_label">开始逻辑卡号</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_beginLogicalId" id="d_beginLogicalId" size="25" maxLength="20" dataType="integer|Limit" min="16" max="20"  msg="输入开始逻辑卡号必须在16位-20位数字范围"/>
                        </td>
                        <td class="table_edit_tr_td_label">结束逻辑卡号</td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_endLogicalId" id="d_endLogicalId" size="25" maxLength="20" dataType="integer|Limit|CompareBigNum"  operator="GreaterThan" to="d_beginLogicalId" min="16" max="20" msg="输入结束逻辑卡号必须在16位-20位数字范围,且值大于于开始逻辑卡号"/>
                        </td>
                        <td class="table_edit_tr_td_label">产生原因: </td>

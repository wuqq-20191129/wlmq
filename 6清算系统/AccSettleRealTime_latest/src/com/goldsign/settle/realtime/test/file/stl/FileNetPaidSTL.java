 ...
 * @author hejj
 */
public class FileNetPaidSTL extends FileBase{
     public static void main(String[] arg) {
        FileNetPaidSTL ft = new FileNetPaidSTL();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="STL82."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
         ...
         */
        /*******************lcc对账数据**************/
        int[] data_type = {File52App.T_STR, File52App.T_INT, File52App.T_INT, File52App.T_INT, File52App.T_INT,

                          
                          };
        int[] data_len = {4,4, 4, 4, 4,
                          
                                                   
                          };
        Object[] datas = {"0201", 5,1000,1, 10000,
                         };
        /****************************************************************************************/

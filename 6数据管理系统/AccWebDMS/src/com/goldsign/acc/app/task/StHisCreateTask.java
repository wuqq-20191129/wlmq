 ...
 */
public class StHisCreateTask extends BaskTask {

    private static Logger logger = Logger.getLogger(StHisCreateTask.class);

    private String taskName;

    public StHisCreateTask() {
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm =  service.doTask(DBConstant.OP_USER + "w_up_dm_st_his_create1", AppCodeConstant.TYPE_RESULT);

    ...
    <body onload="
            ...
            <div id="clearStartHead" class="divForTableBlockHead"  style="width :1800px">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="8"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >盒</td>
                ...
                <table class="table_list_block" id="DataTable" >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            <td  id="boxId" class="table_list_tr_col_data_block">
                                ${rs.boxId}
                            </td>
        ...
        <form method="post" name="detailOp" id="detailOp" action="ticketStorageInAdjustCheck" >
            ...
            <table  class="table_title">
                <tr align="center" >
                    <td colspan="4">
                        <input type="button" id="submit" name="submit" value="确定" onClick="selectItemsForDialog('clearStart','detailOp')" />
                        <input type="button" id="cancel" name="cancel" value="取消" onClick="selectItemsForDialog('clearStart','detailOp')"/>
                    </td>
                </tr>
            </table>

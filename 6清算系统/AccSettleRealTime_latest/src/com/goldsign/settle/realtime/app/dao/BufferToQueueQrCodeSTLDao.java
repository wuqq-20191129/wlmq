 ...
 * @author hejj
 */
public class BufferToQueueQrCodeSTLDao extends BufferToQueueBaseDao{
    ...
    public ResultFromProc bufToQueue(String balanceWaterNo,int balanceWaterNoSub, String fileName) throws Exception {
       // synchronized (SYN) {
            return this.bufToQueueCommon(balanceWaterNo,balanceWaterNoSub, fileName,  "up_st_qp_trf_btoq_stl");
        //}
    }

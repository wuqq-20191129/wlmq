...
<html>
    ...
    <body onload="preLoadVal('q_beginDatetime', 'q_endDatetime');
        ...
        <form method="post" name="queryOp" id="queryOp" action="SignCardLossApplyOpLog">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <table  class="table_edit">
                ...
                <tr class="table_edit_tr">
                    <td class="table_edit_tr_td_label">证件号:</td>
                    <td class="table_edit_tr_td_input">
                        <input type="text" name="q_identityId" id="q_identityId" size="25"  maxLength="18" require="false"  dataType = "NumAndEng" msg="证件号最大18位，仅允许输入数字或字母"/>
                    </td>
                    <td class="table_edit_tr_td_label" rowspan="2">
                        <c:import url="/jsp/common/common_template.jsp?template_name=op_button_list_all_init" />
                        <c:set var="query" scope="request" value="1"/>
                        <c:set var="addClickMethod" scope="request" value="setControlNames('queryOp','q_businessReceiptId#q_cardPrintId#q_beginDatetime#q_endDatetime#q_operatorId#q_oprationType#q_identityId');"/>
            ...
            <div id="clearStartHead" class="divForTableBlockHead" style="width: 2000px"  >
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore" >
                        ...
                        <td id="orderTd"  style="width: 80px"  class="table_list_tr_col_head_block"  isDigit=false index="4"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >证件类型</td>
                        <td id="orderTd"  style="width: 150px"  class="table_list_tr_col_head_block"  isDigit=false index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >证件号码</td>
                        <td id="orderTd"  style="width: 150px"  class="table_list_tr_col_head_block"  isDigit=true index="6"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >印刻号</td>
                        <td id="orderTd"  style="width: 80px"  class="table_list_tr_col_head_block"  isDigit=true index="7"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >票卡余额</td>
                        <td id="orderTd"  style="width: 80px"  class="table_list_tr_col_head_block"  isDigit=false index="8"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >是否折损</td>
                        <td id="orderTd"  style="width: 80px"  class="table_list_tr_col_head_block"  isDigit=true index="9"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >押金</td>
                        <td id="orderTd"  style="width: 80px"  class="table_list_tr_col_head_block"  isDigit=true index="10"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >欠乘车费</td>
                        <td id="orderTd"  style="width: 200px"  class="table_list_tr_col_head_block"  isDigit=false index="11"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >扣款原因</td>
                        <td id="orderTd"  style="width: 80px"  class="table_list_tr_col_head_block"  isDigit=true index="12"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >退款金额</td>
                        <td id="orderTd"  style="width: 160px"  class="table_list_tr_col_head_block"  isDigit=false index="13"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >处理状态</td>
                        <td id="orderTd"  style="width: 300px"  class="table_list_tr_col_head_block"  isDigit=false index="14"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >备注</td>
                    </tr>
                </table>
                ...
                <table class="table_list_block" id="DataTable" >
                    <c:forEach items="${ResultSet}" var="rs">
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);"
                            ...
                            <td  id="identityType" class="table_list_tr_col_data_block" style="width: 80px">
                                ${rs.identityTypeText}
                            </td>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="SignCardLossApplyOpLog" >
            <!-- 表头 通用模板 -->
			<!--导出全部参数 -->
<!--             <input type="hidden" name="expAllFields" id="d_expAllFields" value="OPERATOR_ID,OPERATE_TIME,OPERATE_TYPE,RECEIPT_ID,IDENTITY_TYPE,IDENTITY_ID,CARD_PRINT_ID,CARD_BALANCE_FEE,IS_BROKEN,DEPOSIT_FEE,PENALTY_FEE,PENALTY_REASON,ACTUAL_RETURN_BALA,HDL_FLAG,REMARK" /> -->
            <input type="hidden" name="expAllFields" id="d_expAllFields" value="getOperatorName,getOperateTime,getOperateTypeText,getReceiptId,getIdentityTypeText,getIdentityId,getCardPrintId,getCardBalanceFee,getBrokenText,getDepositFee,getPenaltyFee,getPenaltyReasonText,getActualReturnBala,getHdlFlagText,getRemark" />
			<input type="hidden" name="expFileName" id="d_expFileName" value="记名卡挂失申请操作日志.xlsx" />
			<input type="hidden" name="divId" id="d_divId" value="clearStartHead" />
			<input type="hidden" name="methodUrl" id="d_methodUrl" value="/SignCardLossApplyOpLogExportAll" />
            <c:set var="divideShow" scope="request" value="1"/>
            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
            <c:import url="/jsp/common/common_template.jsp?template_name=op_button_list_all_init" />

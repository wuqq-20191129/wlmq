 ...
 */
package com.goldsign.acc.report.proxy.util;
...
public class Encryption {
    ...
    public static void main(String[] arg){
        ...
        String key="goldsign";
        String mkey="GOLDSIGN";
        String value="acc_st_rpt";
        String encValue =en.biEncrypt(key, value);
        System.out.println("encValue="+encValue);
        String decValue=en.biDecrypt(mkey, encValue);

...
import com.goldsign.settle.realtime.app.vo.FileRecord56;
 ...
 * @author hejj
 */
public class FileRecordParserQrCode56 extends FileRecordParserConstantBase{
     @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecordQrCode56 r = new FileRecordQrCode56();
    ...
    protected FileRecord00DetailResult getInfoForIssueQrCodePlatformFlagFromFile(FileRecordQrCode56 r, char[] b, int offset) throws Exception {
    ...
    protected FileRecord00DetailResult getInfoForIssueQrCodePlatformFlagFromDefault(FileRecordQrCode56 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    protected FileRecord00DetailResult getInfoForIssueQrCodePlatformFlag(FileRecordQrCode56 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    private void handleErrorForUpdateArea(FileRecordQrCode56 r){
    ...
    private void setCheckInfo(FileRecordQrCode56 r) {
    ...
    private String getCheckUniqueKey(FileRecord56 r){
         //唯一性校验主健
    ...
    protected FileRecord00DetailResult getInfoForQrCode(FileRecordQrCode56 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    private FileRecord00DetailResult getInfoForDevice(FileRecordQrCode56 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    private FileRecord00DetailResult getInfoForTrade(FileRecordQrCode56 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

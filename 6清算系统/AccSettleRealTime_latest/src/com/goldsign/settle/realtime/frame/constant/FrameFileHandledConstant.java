...
public class FrameFileHandledConstant {
    ...
    //记录级11-20
    public static String[] FILE_ERR_FILE_HEAD_STATION = {"11", "文件头的车站与名称的车站不一致"};//文件内容的车站与名称的车站不一致
    public static String[] FILE_ERR_FILE_HEAD_SEQ = {"12", "文件头的序列号与名称的序列号不一致"};//文件头的序列号与名称的序列号不一致
    public static String[] FILE_ERR_FILE_HEAD_ROW_COUNT = {"13", "文件头的记录数与实际记录数不一致"};//文件头的记录数与实际记录数不一致
    //处理过程的其他异常30-35
  ...
  /******************************************************************************************************/  
    ...
    public static String[] RECORD_ERR_BLACKLIST = {"47", "黑名单卡交易"};//黑名单卡交易
    public static String[] RECORD_ERR_RETURNED = {"48", "坏卡已退款交易"};//坏卡已退款交易
    
    public static String[] RECORD_ERR_REPEAT_BUSINESS = {"50", "业务重复"};//业务重复
    public static String[] RECORD_ERR_REPEAT_ONE_FILE = {"51", "文件内重复"};//文件内重复
    public static String[] RECORD_ERR_REPEAT_LOT_FILE = {"52", "当天不同文件重复"};//当天不同文件重复
    public static String[] RECORD_ERR_REPEAT_HIS_FILE = {"53", "历史重复"};//历史重复
    ...
    public static String[] FTP_FILE_DATA_TYPE_NAME={"TRX","PRO","AUD","REG"}; //数据类型名称{交易数据，收益数据，审计数据，寄存器数据}
     ...
     */
     ...
     public static String AUD_FILE_PREFIX_ER="ER";//错误文件的审计文件
      public static String AUD_FILE_PREFIX_SDF="SDF";//lcc对账文件

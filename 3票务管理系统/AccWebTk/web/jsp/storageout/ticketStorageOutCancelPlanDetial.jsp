<%-- 
    Document   : TicketStorageOutCancelPlanDetial
    Created on : 2017-8-4
    Author     : luck
--%>
...
<html>
    ...
    <body onload="
            ...
            setPrimaryKeys('detailOp', 'd_waterNo#d_billNo#d_cardMainType#d_cardSubType');
            ...
            <div id="clearStartHead" class="divForTableBlockHead" >
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="8" sortedby="asc"  onclick="sortForTableBlock('clearStart');">工作类型</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="7" sortedby="asc"  onclick="sortForTableBlock('clearStart');">出库原因</td>
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            onclick="setSelectValuesByRowPropertyName('detailOp', 'd_cardSubType', 'commonVariable', 'cardMainCode');
                                    ...
                                    controlByRecordFlagForInit('detailOp', ['add'], true);" 
                            id="${rs.billNo}#${rs.waterNo}" flag="${rs.recordFlag}" cardMainCode="${rs.icMainType}" 
                            storageId="${rs.storageId}" lineId="${rs.lineId}" esWorkTypeId="${rs.esWorktypeId}" exitLineId="${rs.exitLineId}">
        ...
        <form method="post" name="detailOp" id="detailOp" action="ticketStorageOutCancelManage" >
            ...
            <div id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    ...
                    <tr class="table_edit_tr">                      
                        ...
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_drawAmount" id="d_drawAmount" size="10" require="true" maxlength="9" dataType="integer|Positive"  msg="出库数量为大于零的整数!" />
                        </td>
                        ...
                        <td class="table_edit_tr_td_input">
                            ...
                            <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_storagezone_cancel" />
                        </td>
                        <td class="table_edit_tr_td_label">工作类型：</td>
                        <td class="table_edit_tr_td_input">
                            <select id="d_workType" name="d_workType" dataType="Require" msg="工作类型不能为空!" >
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_worktype_cancel" />
                            </select>
                        </td>
                    </tr>
                    <tr class="table_edit_tr">        
                        ...
                        <td class="table_edit_tr_td_input">
                            <select id="d_outReason" name="d_outReason" dataType="Require" msg="出库原因不能为空!" >
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_outreason_cancel" />
                            </select>
                        </td>
                    </tr>
                </table>
            ...
            <c:set var="exportBillAfter" scope="request" value="exportBillDetail('detailOp','w_rpt_ic_rct_bl_plan_cr',['p_bill_no'],['queryCondition'],800,500)"/>

 ...
 * @author goldsign
 */
public class TestSocket50 extends Thread{
...
//    public static final String ipAddress = "127.0.0.1";
    ...
    public static void main(String[] args) {
        TestSocket50 myThread;
        myThread = new TestSocket50();
        myThread.run();
    }
        ...
        try {
            ...
            for (int i=0; i<10; i++) {
                ...
                if(dataType==3){
                    ...
                    sb.append("返回码："+getCharString(data,34,2));//返回码
                    sb.append("错误码："+getCharString(data,36,2));//错误码
                ...
                if(i==2){
                    ...
                    vo.setSamLogicalId("8300000001E00101");
                    vo.setTerminalNo("012003001");
...
//                out.close();
    ...
    private byte[] data(QrPayOrderVo vo){
        byte[] b = new byte[34];
        System.arraycopy("50".getBytes(), 0, b, 0, 2);//消息类型

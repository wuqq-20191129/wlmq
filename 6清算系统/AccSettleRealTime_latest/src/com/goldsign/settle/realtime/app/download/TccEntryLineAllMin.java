 ...
 * @author hejj
 */
public class TccEntryLineAllMin extends FileTccBase {
     private static Logger logger = Logger.getLogger(TccEntryLineAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟线路进站量";
    private static String PROCEDURE_NAME="w_up_st_tcc_EntryLineAllMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccEntryLineAllMinDao dao = new ExportTccEntryLineAllMinDao();

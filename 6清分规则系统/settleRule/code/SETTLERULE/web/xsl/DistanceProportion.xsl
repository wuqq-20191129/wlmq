            ...
            <body onload="initDocument('formQuery','detail');
                ...
                <table width="95%" align="center" class="tableStyle">
                    <tr align="center" class="trTitle">
                        <td colspan="2"><div id = "menuTitle">清分权重查询</div></td>
                    </tr>
                </table>
                <br/>
                    ...
                    <FORM method="post" id="formQuery" name="formQuery" action="distanceProportionAction.do">
                        ...
                        <table width="95%" align="center" class="tableStyle">
                            <tr class="trContent">
                                ...
                                <td width="10%">
                                    <div align="left">
                                        <select id="q_eline_id" NAME="q_eline_id" style="width:100%" dataType="Require" msg="请选择结束线路"
                ...
                <!-- 表头 通用模板
                <xsl:call-template name="common_table_head">
                        <xsl:with-param name="tbName" select="string('统计')" />
                </xsl:call-template>

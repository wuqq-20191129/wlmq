...
import com.goldsign.settle.realtime.app.dao.ExportTccDistributeStationAllMinDao;
 ...
 * @author hejj
 */
public class TccDistributeStationAllMin extends FileTccBase{
    private static Logger logger = Logger.getLogger(TccEntryStationAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟车站集散量";
     private static String PROCEDURE_NAME="w_up_st_tcc_DistStationAllMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccDistributeStationAllMinDao dao = new ExportTccDistributeStationAllMinDao();

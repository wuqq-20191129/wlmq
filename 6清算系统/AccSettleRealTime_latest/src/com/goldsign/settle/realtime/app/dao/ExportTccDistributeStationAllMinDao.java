 ...
 * @author hejj
 */
public class ExportTccDistributeStationAllMinDao extends ExportTccBaseDao{
    private static Logger logger = Logger.getLogger(ExportTccDistributeStationAllMinDao.class.getName());
    ...
    protected String getRecord(DbHelper dbHelper) throws Exception {
        ...
        //最后字段
        sb.append(dbHelper.getItemValue("dist_num") );//集散量

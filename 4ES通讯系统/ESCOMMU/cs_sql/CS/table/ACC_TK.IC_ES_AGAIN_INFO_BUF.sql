DROP TABLE "ACC_TK"."IC_ES_AGAIN_INFO_BUF";
CREATE TABLE "ACC_TK"."IC_ES_AGAIN_INFO_BUF"(
    ...
    mode1              varchar2(3)    DEFAULT '000' NULL
);
ALTER TABLE "ACC_TK"."IC_ES_AGAIN_INFO_BUF" ADD PRIMARY KEY (order_no,logical_id,phy_id);
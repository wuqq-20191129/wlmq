...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="票库入库"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_area_id#p_card_main_type#p_card_sub_type#p_in_reason_id#p_begin_day#p_end_day"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_area_id#p_card_main_type#p_card_sub_type#p_in_reason_id#p_begin_day#p_end_day#bufferFlag"/>
            ...
            <table class="table_edit">
                ...
                <tr class="table_edit_tr">
                    <!--入库原因-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_in_reason_id" />

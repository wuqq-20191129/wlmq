 ...
 * @author hejj
 */
public class FileMobile54App extends FileBase{
    public static String serialNo = "054";

    public static void main(String[] arg) {
        FileMobile54App ft = new FileMobile54App();
       // String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX8100." + ft.getCurrentDate() + "." + FileMobile54App.serialNo;
       //  String fileName = "TRX8000." + "20180629" + "." + FileMobile54App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"8100", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 2};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {
            "54", "10","8100", "04", "001",
            "000000008A654672",100, this.getDealDatetime(), "0800", "8303801102000001",
             "8A563201",103, 20000, 20000, 100, 
            100, "19", "0001", "06A8B090", "0800",
        ...
        Object[] datas_1 = {
            "54", "10","8100", "04", "001", 
            "000000008A654673", 100, this.getDealDatetime(), "0800", "8303801902000001",
            "8A563201",103, 9800, 9800, 100,
             100,"19", "0001", "06A8B090", "0203",
             "830000030200001", this.getDealDatetime(), "999999", "01", "830000030200002",

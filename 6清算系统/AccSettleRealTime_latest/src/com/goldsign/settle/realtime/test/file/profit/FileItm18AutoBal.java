 ...
 * @author hejj
 */
public class FileItm18AutoBal extends FileBase{
    public static void main(String[] arg) {
        FileItm18AutoBal ft = new FileItm18AutoBal();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0118."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0118", "20131106100000", "20131106100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"18", "020102001", this.getDealDatetime(),this.getDealDatetime(), 100,
                          200,20000,40000,1,"0200",
                          "01",1,10000,10000,500,
                          500,400,400,100,100,
                          0,70000};
        /****************************************************************************************/

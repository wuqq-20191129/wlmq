 ...
 * @author hejj
 */
public class FileRecordParser15 extends FileRecordParserBase{
    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
         FileRecord15 r = new FileRecord15();
    ...
    public void handleMessage(MessageBase msg) {
     ...
     private FileRecord00DetailResult getInfoForCommon(FileRecord15 r, char[] b, int offset) throws Exception {
    ...
    private FileRecord00DetailResult getInfoForOther(FileRecord15 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

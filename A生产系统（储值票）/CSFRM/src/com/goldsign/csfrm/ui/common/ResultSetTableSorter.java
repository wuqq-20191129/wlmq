 ...
 */
public class ResultSetTableSorter extends DefaultTableModel {
    ...
    public ResultSetTableSorter() {
        this.mouseListener = new MouseHandler();
        this.tableModelListener = new TableModelHandler();
    }

    public ResultSetTableSorter(TableModel tableModel) {
        this();
        setTableModel(tableModel);
    }

    public ResultSetTableSorter(TableModel tableModel, JTableHeader tableHeader) {
        this();
    ...
    private class TableModelHandler implements TableModelListener {
        ...
        public void tableChanged(TableModelEvent e) {
            ...
            if (e.getFirstRow() == e.getLastRow()
                ...
                fireTableChanged(new TableModelEvent(ResultSetTableSorter.this,
                        viewIndex, viewIndex,
                        column, e.getType()));
                return;
            }

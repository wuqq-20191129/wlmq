...
<html>
    <head>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="InnerLineBalanceByDay">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="InnerLineBalanceByDay"/>

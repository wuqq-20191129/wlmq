 ...
 * @author hejj
 */
public class FileMobileSTL extends FileBase {

    public static void main(String[] arg) {
        FileMobileSTL ft = new FileMobileSTL();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "STL81." + ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"81", this.getStartTime(), this.getEndTime(), 1};
        /**
         * ******************************************
         */
        /**
         ...
         * *****************lcc对账数据*************
         */
        int[] data_type = {File52App.T_STR, File52App.T_INT, File52App.T_INT, File52App.T_STR,File52App.T_STR,
            File52App.T_INT, File52App.T_INT,File52App.T_STR,File52App.T_STR,File52App.T_INT,
            File52App.T_INT, File52App.T_INT, File52App.T_INT, File52App.T_INT,File52App.T_INT,
            File52App.T_STR,File52App.T_STR,File52App.T_STR,File52App.T_STR,File52App.T_INT,
            File52App.T_INT,File52App.T_INT,File52App.T_STR,File52App.T_STR

        };
        int[] data_len = {4, 4, 4,2,4,
            4, 4,2,4,4,
            4, 4, 4, 4, 4,
            2,4,2,4,4,
            4,4,2,4
        ...
        Object[] datas = {"8100", 50000, 5, "01","0001",
            1,10000,"03","9999",6, 
            60000,2, 3,15,600,
            "04","9999","01","1999",299,
            5,50000,"02","2000"

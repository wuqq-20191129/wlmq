...
import com.goldsign.settle.realtime.app.dao.ExportTccExitStationAllMinDao;
 ...
 * @author hejj
 */
public class TccExitStationAllMin extends FileTccBase{
    private static Logger logger = Logger.getLogger(TccEntryStationAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟车站出站量";
     private static String PROCEDURE_NAME="w_up_st_tcc_ExitStationAllMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccExitStationAllMinDao dao = new ExportTccExitStationAllMinDao();

 ...
 * @author hejj
 */
public class BufferToQueueNetPaidORDDao extends BufferToQueueBaseDao{
    ...
    public ResultFromProc bufToQueue(String balanceWaterNo,int balanceWaterNoSub, String fileName) throws Exception {
       // synchronized (SYN) {
            return this.bufToQueueCommon(balanceWaterNo,balanceWaterNoSub, fileName, FrameDBConstant.DB_ST + "up_st_np_trf_buf_queue_ord");
        //}
    }

 ...
 * @author hejj
 */
public class FileMobile57App extends FileBase{
    public static String serialNo = "057";

    public static void main(String[] arg) {
        FileMobile57App ft = new FileMobile57App();
       // String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX8000." + ft.getCurrentDate() + "." + FileMobile57App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] datas = {
            "57", "8000", "09", "802", "0000000000000000",
            0, "0200", "4100000300000001", "8A563201", 114,
            10000, 0, 0, "01", 1,
            "0", this.getDealDatetime(), "0000", this.getDealDatetime(), "08A95401",
            "000000", "00", 0, "0", "09",
            "000000000000","13588887777","01","0001"
        };
        /**
         * *****************退款交易信息*************
         */

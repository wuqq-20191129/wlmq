 ...
 */
public class StHisMvTask extends BaskTask {

    private static Logger logger = Logger.getLogger(StHisMvTask.class);
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm =  service.doTask(DBConstant.OP_USER + "w_up_dm_st_his_mv1", AppCodeConstant.TYPE_RESULT);

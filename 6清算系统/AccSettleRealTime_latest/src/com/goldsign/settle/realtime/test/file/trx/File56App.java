 ...
 * @author hejj
 */
public class File56App extends FileBase{
    public static String serialNo="056";
      public static void main(String[] arg) {
        File56App ft = new File56App();
      //  String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
       String fileName="TRX0103."+ft.getCurrentDate()+"."+File56App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0103", this.getStartTime(),this.getEndTime(), Integer.parseInt(serialNo), 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {
            "56","10", "0103", "03", "001", 
            "8300000302A00001",100, "0842", "8300000300000001", "8A563201",
            101,111, "1", "01",this.getDealDatetime(), 
            "01",500, "0001", "999999", "0103",
            "01","0","000","0000","0000",
            "1",this.getDealDatetime()
        };
         /*******************更新信息**************/

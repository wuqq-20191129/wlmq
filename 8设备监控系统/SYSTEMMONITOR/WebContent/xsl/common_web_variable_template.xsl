...
<xsl:template name="common_web_variable">
 ...
 <DIV id="enableAlwaysObs" value=""/>
	...
	<!-- 修改权限对应按钮-->
	<DIV id="priviModify" name="priviModify" value="btModify,btModify1,btSave,btSave1,btCancle" />
	
	<!-- 克隆权限对应按钮-->
	<DIV id="priviClone" name="priviClone" value="btClone" />
	<!-- 提交权限对应按钮-->
	<DIV id="priviSubmit" name="priviSubmit" value="btSubmit,btDetailSubmit" />
	<!-- 导出权限对应按钮-->
...
<!-- 点击克隆按钮时,可用的其他按钮 -->
	...
	<DIV id="op_add" avriable="btSave,btCancle,btSave1" />
     <!-- 点击删除按钮时,可用的其他按钮 -->
	<DIV id="op_del" avriable="btClone,btAdd,btDelete,btAudit,btCheck,btSubmit,btDetailSubmit,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" />
	<!-- 点击审核按钮时,可用的其他按钮 -->
	<DIV id="op_audit" avriable="btClone,btAdd,btDelete,btAudit,btCheck,btSubmit,btDetailSubmit,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" />
	<!-- 点击导入按钮时,可用的其他按钮 -->
	<DIV id="op_import" avriable="btClone,btAdd,btDelete,btCheck,btSubmit,btDetailSubmit,btPrint,btImport,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" />
	<DIV id="op_import1" avriable="btClone,btAdd,btDelete,btCheck,btSubmit,btDetailSubmit,btPrint,btImport1,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd" />
<!-- 点击修改按钮时,可用的其他按钮 -->
	<DIV id="op_modify" avriable="btSave,btCancle,btSave1" />

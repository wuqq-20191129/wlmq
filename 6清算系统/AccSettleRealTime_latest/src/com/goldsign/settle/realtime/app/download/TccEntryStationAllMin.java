 ...
 * @author hejj
 */
public class TccEntryStationAllMin extends FileTccBase {

    private static Logger logger = Logger.getLogger(TccEntryStationAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟车站进站量";
     private static String PROCEDURE_NAME="w_up_st_tcc_EntryStationAllMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccEntryStationAllMinDao dao = new ExportTccEntryStationAllMinDao();

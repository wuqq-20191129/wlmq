<%-- 
    Document   : system_rate_line
    Created on : 2017-6-8, 19:31:40
    Author     : liudezeng
--%>
...
<html>
    ...
    <c:choose>
        ...
        <form method="post" name="queryOp" id="queryOp" action="SystemRateLine">
            <!-- 页面用到的变量 通用模板 -->
...
<c:import url="/jsp/common/common_template.jsp?template_name=common_status_table" />            
            ...
            <div id="clearStartHead" class="divForTableBlockHead">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="1"  sortedby="asc" onclick="sortForTableBlock('clearStart');"  style="width: 120px">线路</td>
            ...
            <div id="clearStart"  class="divForTableBlockData">
                <table class="table_list_block" id="DataTable" >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        id="${rs.line_id}#${rs.service_rate}#${rs.version_no}#${rs.record_flag}">
                            ...
                            <td  id="lineID" class="table_list_tr_col_data_block" style="width: 120px">
                                ${rs.line_id_name}
                            </td>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="SystemRateLine" >
            <input type="hidden" name="expAllFields" id="d_expAllFields" value="line_id_name,service_rate" />
            <input type="hidden" name="expFileName" id="d_expFileName" value="线路服务费率.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead" />
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/SystemRateLineExportAll" />
            ...
            <DIV id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    <tr class="table_edit_tr">
                        ...
                        <td class="table_edit_tr_td_input">
                            <select  name="d_lineID"  id="d_lineID" require="true" dataType="LimitB" min="1" msg="线路不能为空">
            ...
            <c:set var="addQueryMethod" scope="request" value="setLineCardNames('detailOp','d_lineID','','','','','');"/>

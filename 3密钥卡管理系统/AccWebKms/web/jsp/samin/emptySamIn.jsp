...
<html>
    ...
    <body onload="initDocument('queryOp', 'detail');
        ...
        <form method="post" name="queryOp" id="queryOp" action="emptySamInAction">
            <!-- 页面用到的变量 通用模板 -->
        ...
        <div id="clearStartBlock" class="divForTableBlock" >
            <div id="clearStartHead" class="divForTableBlockHead" style="width: 127%">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="3"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 100px">领卡人员</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >入库人员</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="6"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 130px">入库时间</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="7"  sortedby="asc" onclick="sortForTableBlock('clearStart');" > 审单人</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=true index="9"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >连续卡数量</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="10" sortedby="asc"  onclick="sortForTableBlock('clearStart');" style="width: 120px">起始逻辑卡号</td>
            ...
            <div id="clearStart"  class="divForTableBlockData" style="width: 127%">
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="emptySamInAction" >

            <c:set var="divideShow" scope="request" value="1"/>
            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
            
            <input type="hidden" name="expAllFields" id="d_expAllFields"
                   value="getOrderNo,getSamTypeName,getGetCardOper,getOrderStateName,getInStockOper,getInStockTime,getAuditOrderOper,getAuditOrderTime,getOrderNum,getStartLogicNo,getRemark" />
            <input type="hidden" name="expFileName" id="d_expFileName" value="新购卡入库.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead">
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/EmptySamInExportAll"/>

...
public class AppPlugIn implements PlugIn{
	...
	public void destroy()
	{
		if (loggerServiceConfig != null) loggerServiceConfig = null;
        return;
    }
    /**
    ...
    /**
     * Get the ActionServlet instance that is managing all the modules in this web application
     *
     * @return ActionServlet        - ActionServlet that is managing all the modules in this web application
     *
     */
    ...
    /**
     * Set the ActionServlet instance that is managing all the modules in this web application
     *

 ...
 * @author goldsign
 */
public class TestSocket34 extends Thread{
...
//    public static final String ipAddress = "127.0.0.1";
    ...
    public static void main(String[] args) {
        TestSocket34 myThread;
        myThread = new TestSocket34();
        myThread.run();
    }
...
//                }else if(i==2){
                ...
                if(dataType==3){
                    ...
                    sb.append(","+getCharString(data, 64, 11));//
                    sb.append(","+getLong(data, 75));//空充系统参照编号
                    sb.append(","+getBcdString(data, 79, 7));//
                    sb.append(","+getCharString(data, 86, 2));//
                    sb.append(","+getCharString(data, 88, 2));//
...
//                socket.setSoLinger(true, 0);
    ...
    private byte[] data(){
        byte[] b = new byte[174];
        System.arraycopy("34".getBytes(), 0, b, 0, 2);//消息类型
        ...
        System.arraycopy("0000000000000000".getBytes(), 0, b, 124, 16);//
        System.arraycopy(bcdStringToByteArray("20171112101000"), 0, b, 140, 7);//
        System.arraycopy("000000".getBytes(), 0, b, 147, 6);//
        System.arraycopy("13400000000".getBytes(), 0, b, 153, 11);//
        System.arraycopy("01".getBytes(), 0, b, 164, 2);//
        System.arraycopy("0000".getBytes(), 0, b, 166, 4);//
        System.arraycopy(longStringToByteArray(0L,4), 0, b, 170, 4);//

        ...
        <script>
            ...
            function preLoadVal() {
                ...
                if (selectedVer == 1) {
                    ...
                    document.getElementById("d_ver_date_begin").disabled=false;//选择未来版本时，版本起始时间可编辑 20180302 zhouy
                }else{
                    document.getElementById("d_ver_date_begin").disabled=true;//选择当前版本时，版本起始时间不可编辑 20180302 zhouy
                }
                var year = current.getFullYear();
                var month = current.getMonth() + 1;
                var day = current.getDate();
            ...
            <table class="tableStyle">
                <tr>
                    ...
                    <td width="150"><div align="left">
                            ...
                            <input type="text" id="d_ver_date_begin"  name="d_ver_date_begin" size="10" readonly="1" onClick="openCalenderDialogByID('d_ver_date_begin','true');" require="false"/>
                            ...
                            <!--	</a> -->
                            <a href="javascript:openCalenderDialogByID('d_ver_date_begin','true');">
                ...
                <tr>
                    ...
                    <td width="150"><div align="left">
                            ...
                            <input type="text" id="d_ver_date_end"  name="d_ver_date_end" size="10" readonly="1" onClick="openCalenderDialogByID('d_ver_date_end','true');" require="false"/>
                            ...
                            <a href="javascript:openCalenderDialogByID('d_ver_date_end','true');">
                                <img src="../../images/calendar.gif" width="15" height="15" border="0" style="block"/>
                            </a>
                        </div>
                    </td>
                ...
                <tr>
                    <td width="150"><div align="right">
                            <input type="radio"  name="generateversion" id="generateversion"  onClick="preLoadVal();" />当前版本</div>
                    </td>
                    <td width="150"><div align="left">

 ...
 * @author hejj
 */
public class File61Admin extends FileBase {

    public static String serialNo = "061";

    public static void main(String[] arg) {
        File61Admin ft = new File61Admin();
        //  String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0109." + ft.getCurrentDate() + "." + File61Admin.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0109", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 1};
        /**
         * ******************************************
         */
        /**
        ...
        int[] data_type = {File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_STR,
                           File52App.T_BCD, File52App.T_BCD, File52App.T_BCD, File52App.T_INT, File52App.T_INT,
                           File52App.T_BCD, File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_BCD};
        int[] data_len = {2, 2, 4, 2, 3,
                          7, 1, 2, 2, 2,
                          1, 60, 30, 6, 1,};
        Object[] datas = {"61", "10", "0109", "03", "001",
                         this.getDealDatetime(), "03", "0100", 0, 400,
                         "23", "乘客车票遗失", "张力", "000001", "01"
        };
        /**
         * *************************************************************************************
         */

 ...
 * Date          By             Description
 * ----------    -----------    -------------------------------------------
 * 2005-02-24    Rong Weitao    Create the class
 */
...
public class Encryption{
	public static String ENC_KEY="ditie123456";
    ...
    public static void main(String[] args){
    	String pass="0D0A171A5D09";
    	Encryption en = new Encryption();
    	System.out.println(en.biDecrypt(Encryption.ENC_KEY,pass));

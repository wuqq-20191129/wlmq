<%-- 
    Document   : ReportSTHandinDetail
    Created on : 2017-8-9, 11:22:56
    Author     : chenzx
--%>
...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="弃票/弃票回收箱储值票上交月报"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_line_id#p_year#p_month"/>
            <c:set var="QueryDateNames" scope="request" value="p_year#p_month"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_line_id#p_year#p_month#bufferFlag"/>
            ...
            <table class="table_edit">
                <tr class="table_edit_tr">
                    ...
                    <!--年月-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_year_month" />
                ...
                <tr class="table_edit_tr">
                    ...
                    <td colspan="7">
                        <div align="left">查询条件的日期为车站上交数据的报表日期</div>
                    </td>
                </tr>
            </table>
        </form>

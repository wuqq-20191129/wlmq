...
public class ClusterAct extends BaseAction {
    ...
    private void convertText(Vector statues) throws Exception {
        ...
        for (int i = 0; i < statues.size(); i++) {
            vo = (ClusterVo) statues.get(i);
            vo.setStatusText(dbUtil.getTextByCode(vo.getStatus(), statuesFlags));
        }
    }

    public ActionMessage query(HttpServletRequest request, ClusterDao pmb, Vector statues, String command) throws Exception {

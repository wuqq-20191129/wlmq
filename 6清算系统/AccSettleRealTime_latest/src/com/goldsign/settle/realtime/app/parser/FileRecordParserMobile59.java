 ...
 * @author hejj
 */
public class FileRecordParserMobile59 extends FileRecordParserBase{
     @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecordMobile59 r = new FileRecordMobile59();
    ...
    private FileRecord00DetailResult getInfoForDevice(FileRecordMobile59 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

        int len = 2;
        //r.setTrdType(this.getCharString(b, offset, len));//1交易类型
        r.setTrdType(this.getTrdTypeForMobile(this.getCharString(b, offset, len)));//交易类型增加前缀Mobile 即Mobile59
        offset += len;
    ...
    private FileRecord00DetailResult getInfoForTrade(FileRecordMobile59 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
        ...
        len = 11;
        r.setMobileNo(this.getCharString(b, offset, len));//16手机号码
        offset += len;

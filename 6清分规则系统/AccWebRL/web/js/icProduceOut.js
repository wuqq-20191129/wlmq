...
function generateFunction(formName){
    setCommand(formName,"generate");
    setSubmitForm(formName);
    generateAction(formName);
}

function generateODFunction(formName){
...
//生成按钮提交
function generateAction(formName){
    frm = document.forms[formName];
    document.getElementById('promptMessageId').innerHTML="请稍等...";
    frm.submit();
}

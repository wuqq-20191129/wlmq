 ...
 * @author hejj
 */
public class File74App extends FileBase{
     public static String serialNo = "074";

    public static void main(String[] arg) {
        File74App ft = new File74App();
        // String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0110." + ft.getCurrentDate() + "." + File74App.serialNo;
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] datas = {
            "74", "12", "0101", "04", "001",
            "000000008A654672", 100, this.getDealDatetime(), "1100", "8303991102000001",
            ...
            "0000000000000000000000000000000000000001", "0000000000000000000000000000000000000002",this.getDealDatetime()

        };
        Object[] datas_1 = {
            "74", "12", "0101", "04", "001",
            "000000008A654673", 100, this.getDealDatetime(), "1242", "8303C11102000001",
            "8A563201", 103, 200, 9800, 100,
            100, "12", "0001", "06A8B090", "0203",
            "830000030200001", this.getDealDatetime(), "999999", "01", "8303C21102000001",
            ...
            "0000000000000000000000000000000000000003", "0000000000000000000000000000000000000004", this.getDealDatetime()
        };
        /**
         * *****************钱包交易信息*************
         */

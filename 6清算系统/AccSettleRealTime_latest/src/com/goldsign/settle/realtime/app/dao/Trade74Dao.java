 ...
 * @author hejj
 */
public class Trade74Dao extends TradeBaseDao{
     private static Logger logger = Logger.getLogger(Trade74Dao.class.getName());
    ...
    @Override
     public int insertError(FileRecordBase frb,String errCode)  {
        ...
        FileRecord74 vo = (FileRecord74) frb;

        String sql = "insert into "+FrameDBConstant.DB_PRE+"ST_ERR_DEAL_QRCODE(LINE_ID,STATION_ID,DEV_TYPE_ID,DEVICE_ID,SAM_LOGICAL_ID,"
                                             ...
                                             + "?,?,?,?,?,"
                                             + "?,?,?,?,?,"
                                             + "?,W_ACC_ST.W_SEQ_W_ST_ERR_DEAL_QRCODE.nextval,?,?,?,"
                                             + "?,?,?,?,?,"
                                             + "?,?,?,?,?,"
                                             + "?,?,?,?,?,"
                                             +"?,?,?,?,?,"

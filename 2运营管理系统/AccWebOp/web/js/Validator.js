...
ICCSDateAndNull:/^$|^[0-9]{4}-[0-9]{2}-[0-9]{2}$/,
ICCSDateTime:/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$/,
ICCSDateTime1:/^[0-9]{4}[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}[0-9]{2}$/,
...
CompareTime : "this.compareTime(document.getElementById(getAttribute('hh1')).value,document.getElementById(getAttribute('mm1')).value,document.getElementById(getAttribute('hh2')).value,document.getElementById(getAttribute('mm2')).value,document.getElementById(getAttribute('hh')).value,document.getElementById(getAttribute('mm')).value)",
dateDiff:"this.dateTimeDiff(getAttribute('name'), getAttribute('to'))",
CheckPenatlyReason:"this.checkPenatlyReason(getAttribute('id'),getAttribute('from'))",
...
CountStr : function(str){//add by zhongziqi 20170705
...
compareBigNum : function(op1,operator,op2){//add by zhongziqi 20170718
...
checkPenatlyReason:function (control,from){
//	alert(document.getElementById(control).value+"||"+document.getElementById(from).value);
	var penatlyResonIndex = document.getElementById(control).value;
	var penatlyFee = document.getElementById(from).value;
	if((penatlyFee>0&&penatlyResonIndex=='')||(penatlyFee==0&&penatlyResonIndex!='')){
		return false;
	}else{
		return true;
	}
...
function GetFullYear(y){return ((y<30 ? "20" : "19") + y)|0;}
 ...
 dateTimeDiff:function dateDiff(datetime1,datetime2) {
   ...
   var M1= document.getElementById(datetime1).value;
    ...
    compareTime : function(hh1,mm1,hh2,mm2,hh,mm){//add by zhouy 20171220
//比较停售开始时间1、停售开始时间2、停售结束时间的大小，不允许停售结束时间<停售开始时间2<停售开始时间1的情况
        var T1 = hh1+mm1;
        var T2 = hh2+mm2;
        var T  = hh+mm;
        if(T1=="" || T2=="" || T==""){

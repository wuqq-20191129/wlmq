...
<html>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageInNewManage">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <table  class="table_edit">
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_input">
                        <input type="text" id="q_billNo" name="q_billNo" value="" size="12" maxlength="12"  require="false"
                               dataType="NumAndEng|LimitB" min="12" max="12"  msg="入库单号应为12位数字或字母组合" />
                    </td>
            ...
            <div id="clearStartHead" class="divForTableBlockHead" style="width: 103%">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >票管员</td>
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            <td  id="billNo" class="table_list_tr_col_data_block" style="width: 90px">
                                <a href='#'
                                   onClick="openwindow('ticketStorageInNewDetailController?queryCondition=${rs.bill_no}&command=queryDetail&operType=planDetail&billRecordFlag=${rs.record_flag}&ModuleID=${ModuleID}', '', 1200, 800)"> 
                                    ${rs.bill_no}
                                </a>                               
                            </td>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="ticketStorageInNewManage" >
            ...
            <input type="hidden" name="expFileName" id="d_expFileName" value="新票入库.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead">
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/TicketStorageInNewExportAll"/>
                ...
                <table  class="table_edit_detail">
                    <tr class="table_edit_tr">
                        ...
                        <td class="table_edit_tr_td_input" style="width:100px">
                            <input type="text" name="d_remarks" id="d_remarks" size="70"  dataType="Required|LimitContainChinese" maxlength="256" max="256" msg="备注最大长度为256个字节，一个中文字符占3个字节"/>
                        </td>

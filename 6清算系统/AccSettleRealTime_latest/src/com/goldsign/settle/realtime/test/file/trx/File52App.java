 ...
 * @author hejj
 */
public class File52App extends FileBase{
    public static String serialNo="052";
   
    
    public static void main(String[] arg) {
        File52App ft = new File52App();
      //  String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
       String fileName="TRX0111."+ft.getCurrentDate()+"."+File52App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0111", this.getStartTime(),this.getEndTime(), Integer.parseInt(serialNo), 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        int[] data_type = {File52App.T_STR,File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_STR,
            ...
            File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_STR, File52App.T_BCD,
            File52App.T_BCD, File52App.T_STR,File52App.T_BCD,File52App.T_STR};
        int[] data_len = {2,2, 4, 2, 3,
                          30, 1, 1, 18, 4,
                          16, 16, 200, 6, 7,
                          1, 1,2,1};
        Object[] datas = {"52","10", "0111", "03", "001", 
                          "张力", "1", "1", "230103198402015519", "20200101",
                          "81891712", "81891712", "湖南长沙铭鸿分公司", "888888",this.getDealDatetime(),
                          "01", "0","0201","2"};
        /****************************************************************************************/

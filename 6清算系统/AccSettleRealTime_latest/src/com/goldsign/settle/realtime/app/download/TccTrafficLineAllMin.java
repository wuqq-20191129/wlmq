...
import com.goldsign.settle.realtime.app.dao.ExportTccTrafficLineAllMinDao;
 ...
 * @author hejj
 */
public class TccTrafficLineAllMin extends FileTccBase{
     private static Logger logger = Logger.getLogger(TccEntryLineAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟线路客运量";
    private static String PROCEDURE_NAME="w_up_st_tcc_TrafficLineAllMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccTrafficLineAllMinDao dao = new ExportTccTrafficLineAllMinDao();

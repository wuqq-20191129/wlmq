...
<c:choose>
    ...
    <c:when test="${templateName == 'common_web_variable'}">
        ...
        <!-- 修改权限对应按钮-->
        <DIV id="priviModify" name="priviModify" value="btModify,btModify1,btSave,btSave1,btCancle,btUpdateId" ></DIV>
        ...
        <!-- 定义所有功能按钮 -->
         ...
         <DIV id="functions" value="btClone,btAdd,btDelete,btModify,btModify1,btCheck,btSave,btSave1,btSubmit,btDetailSubmit,btSubmitSam,btUpdateId,btCancle,btPrint,btPrint1,btPrint2,btPrint3,btImport,btImport1,btExport,btExportBill,btExport1,btQuery,btDownload,btStatistic,btReportQuery,btCheck1,btDownload1,btDistribute,btRefundOk,btRefundNo,btRefundMd,btRefundCk,btAudit,btBack,btBackEnd,btNext,btNextEnd,btExpAll" ></DIV>
        ...
        <!-- 点击修改按钮时,可用的其他按钮 -->
        <DIV id="op_modify" avriable="btSave,btCancle,btSave1,btUpdateId" ></DIV>
        ...
        <!-- 点击保存按钮时,可用的其他按钮 -->
        <DIV id="op_save" avriable="btClone,btAdd,btDelete,btAudit,btModify,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd,btExpAll" ></DIV>
        <DIV id="op_save1" avriable="btClone,btAdd,btDelete,btAudit,btModify,btPrint,btExport,btExportBill,btBack,btBackEnd,btNext,btNextEnd,btExpAll" ></DIV>

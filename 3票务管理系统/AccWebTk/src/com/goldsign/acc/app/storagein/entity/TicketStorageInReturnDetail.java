 ...
 * 20170817
 */
public class TicketStorageInReturnDetail implements Serializable {
    ...
    private int tickettype_id;//票务接口上传的票卡类型，用于回收入库
    ...
    private String line_name="";//回收线路名称（用于页面显示）
    private String station_name="";//回收车站名称（用于页于显示）
    
    private String date;
    private String lineAuthSql;

    public String getLineAuthSql() {
        return lineAuthSql;
    }

    public void setLineAuthSql(String lineAuthSql) {
        this.lineAuthSql = lineAuthSql;
    }

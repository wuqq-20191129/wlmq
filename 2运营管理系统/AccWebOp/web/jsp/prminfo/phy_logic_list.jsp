...
<script language="javascript" type="text/javascript" charset="utf-8" src="js/common_form_extend.js"></script>
        ...
        <script language="javascript" >
            ...
            function OpenDialog() {
                var openUrl ='phyLogicListImp?command=import';
    ...
    <body onload="preLoadVal('q_begin_time' , 'q_end_time');
        ...
        <form method="post" name="queryOp" id="queryOp" action="phyLogicList">
            <!-- 页面用到的变量 通用模板 -->
                ...
                <c:forEach items="${ResultSet}" var="rs">
                    <tr class="table_list_tr_data" 
                        ...
                        <td  id="openBrWindow" class="table_list_tr_col_data_block" style="width: 80px">
                            <a href="#" onClick="MM_openBrWindow('PhyLogicListDetail?type=null&ModuleID=${ModuleID}&waterNo=${rs.water_no}','物理逻辑卡号查看操作','scrollbars=yes,resizable=yes,width=800,height=500')">查看</a>
                            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
                        </td>	
                    </tr>
                </c:forEach>
    ...
    <!-- 表头 通用模板 -->
        <FORM method="post" name="detailOp" id="detailOp" action="phyLogicList">
            <input type="hidden" name="importUrl" id="importUrl" value="phyLogicList?command=import" />
            <c:set var="divideShow" scope="request" value="1"/>
            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
            <!--导出全部参数 -->
            <input type="hidden" name="expAllFields" id="d_expAllFields"
                value="getWater_no,getOperator_id,getOp_time,getFile_name,getBegin_logical_id,getEnd_logical_id,getRecord_count,getRemark" />
            <input type="hidden" name="expFileName" id="d_expFileName" value="物理逻辑卡号对照表.xlsx" />

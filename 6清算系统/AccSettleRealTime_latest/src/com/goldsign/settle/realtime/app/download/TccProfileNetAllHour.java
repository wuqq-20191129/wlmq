...
import com.goldsign.settle.realtime.app.dao.ExportTccProfileNetAllHourDao;
 ...
 * @author hejj
 */
public class TccProfileNetAllHour extends FileTccBase {
    private static Logger logger = Logger.getLogger(TccProfileNetAllHour.class.getName());
    private static String EXPORT_FILE_NAME = "小时线路断面客流";
    private static String PROCEDURE_NAME = "w_up_st_tcc_ProfileNetAllHour";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccProfileNetAllHourDao dao = new ExportTccProfileNetAllHourDao();

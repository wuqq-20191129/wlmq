...
import com.goldsign.settle.realtime.app.dao.ExportTccProfileInfoDao;
 ...
 * @author hejj
 */
public class TccProfileInfo extends FileTccBase{
    private static Logger logger = Logger.getLogger(TccProfileInfo.class.getName());
    private static String EXPORT_FILE_NAME = "断面信息";
    private static String PROCEDURE_NAME = "w_up_st_tcc_ProfileInfo";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccProfileInfoDao dao = new ExportTccProfileInfoDao();

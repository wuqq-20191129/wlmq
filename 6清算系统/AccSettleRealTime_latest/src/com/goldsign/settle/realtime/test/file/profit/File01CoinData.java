 ...
 * @author hejj
 */
public class File01CoinData extends FileBase{
     public static void main(String[] arg) {
        File01CoinData ft = new File01CoinData();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0101."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0101", "20131106020000", "20131106235959", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"01", "020102001", "1", "000001", this.getDealDatetime(), 
            this.getDealDatetime(), 100,8,
            1000, 5000,
            100000,200000, 
            0,0,
            0,0,
    ...
    public char[] getBufferCharForLine() throws UnsupportedEncodingException {
        ...
        Object[] datas = {"01", "020102001", 1, "000001", this.getStartTime(), 

 ...
 * @author hejj
 */
public class Trade56Dao extends TradeBaseDao{
     private static Logger logger = Logger.getLogger(Trade56Dao.class.getName());
    ...
    public int insertError(FileRecordTacBase frb) throws Exception {
     ...
     public int insertError(FileRecordBase frb,String errCode)  {
        ...
        FileRecord56 vo = (FileRecord56) frb;

        String sql = "insert into W_ACC_ST.W_ST_ERR_UPDATE(LINE_ID,STATION_ID,DEV_TYPE_ID,DEVICE_ID,SAM_LOGICAL_ID,"
                                             ...
                                             + "WATER_NO,CARD_APP_MODE,BALANCE_WATER_NO_SUB,RECORD_VER,TCT_ACTIVE_DATETIME "                                          
                                             + ") "
                                             + "values(?,?,?,?,?,"
                                             + "?,?,?,?,?,"
                                             + "?,?,?,?,?,"
                                             ...
                                             + "?,?,?,?,?,"
                                             + "?,?,?,?,?," 
                                             + "W_ACC_ST.W_SEQ_W_ST_ERR_UPDATE.nextval,?,?,?,?"               
                                              + ") ";

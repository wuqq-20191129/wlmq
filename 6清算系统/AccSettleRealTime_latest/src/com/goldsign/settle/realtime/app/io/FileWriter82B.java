 ...
 * @author hejj
 */
public class FileWriter82B extends FileWriterBase{
    @Override
    ...
    public String getLine(FileRecordBase vob) {
        ...
        sb.append(this.convertFenToYuan(vo.getCardMoney())+ FileWriterBase.FIELD_DELIM);//硬币面值
        sb.append(vo.getCoinReceiveNum()+ FileWriterBase.FIELD_DELIM);//硬币接收数量
        sb.append(this.convertFenToYuan(vo.getCoinReceiveFee())+ FileWriterBase.FIELD_DELIM);//硬币接收金额

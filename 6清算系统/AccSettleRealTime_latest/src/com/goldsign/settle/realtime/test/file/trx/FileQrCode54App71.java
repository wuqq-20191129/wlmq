 ...
 * @author mh
 */
public class FileQrCode54App71 extends FileBase{
    public static String serialNo = "054";

    public static void main(String[] arg) {
        FileQrCode54App71 ft = new FileQrCode54App71();
        // String path = "D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX7100." + ft.getCurrentDate() + "." + File54App.serialNo;
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"7100", this.getStartTime(), this.getEndTime(), Integer.parseInt(serialNo), 2};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {
            "54", "11", "0101", "04", "001",
            "000000008A654672", 100, this.getDealDatetime(), "1100", "8303801102000001",
            ...
            "01", "林郑月娥", "01", "440108197202115519", 0,
            0, "201901", 800, 600, this.getDealDatetime(),
            "0000000000000000000000000000000000000001", "0000000000000000000000000000000000000002","02"

        };
        Object[] datas_1 = {
            "54", "11", "0101", "04", "001",
            "000000008A654673", 100, this.getDealDatetime(), "1200", "8303801902000001",
            "8A563201", 103, 200, 9800, 100,
            ...
            0, "201901", 1200, 900, this.getDealDatetime(),
            "0000000000000000000000000000000000000003", "0000000000000000000000000000000000000004","02"
        };
        /**
         * *****************钱包交易信息*************
         */

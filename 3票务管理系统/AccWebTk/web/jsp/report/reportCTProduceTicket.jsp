...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="车票生产报表"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_device_id#p_worktype_id#p_card_main_type#p_card_sub_type#p_storage_id#p_operator_id#p_begin_day#p_end_day"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_device_id#p_worktype_id#p_card_main_type#p_card_sub_type#p_storage_id#p_operator_id#p_begin_day#p_end_day#bufferFlag"/>
            <c:import url="/jsp/common/common_template_web_variable_ic.jsp?template_name=common_web_variable_report" />
            
            <table class="table_edit">
                <tr class="table_edit_tr">
                    <!--设备ID-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_device_id" />
                    
                    <!--操作类型-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_worktype_id" />
                ...
                <tr class="table_edit_tr">
                    <!--仓库-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_storage_id" />
                    
                    <!--操作员ID-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_operator_id" />
                ...
                <tr class="table_edit_tr">
                    ...
                    <td colspan="7">
                        <div align="left">查询条件的日期为生产工作单审核日期</div>
                    </td>
                </tr>
            </table>
        </form>

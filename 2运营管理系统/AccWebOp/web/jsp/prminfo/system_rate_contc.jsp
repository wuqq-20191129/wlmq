<%-- 
    Document   : system_rate_contc
    Created on : 2017-6-13, 10:31:40
    Author     : liudezeng
--%>
...
<html>
    ...
    <c:choose>
       ...
       <form method="post" name="queryOp" id="queryOp" action="SystemRateContc">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <div id="clearStartHead" class="divForTableBlockHead">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="1"  sortedby="asc" onclick="sortForTableBlock('clearStart');"  style="width: 120px">运营商</td>
            ...
            <div id="clearStart"  class="divForTableBlockData">
                <table class="table_list_block" id="DataTable" >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        id="${rs.contc_id}#${rs.service_rate}#${rs.version_no}#${rs.record_flag}">
                            ...
                            <td  id="contcID" class="table_list_tr_col_data_block" style="width: 120px">
                                ${rs.contc_id_name}
                            </td>
                            <td  id="serviceRate" class="table_list_tr_col_data_block" style="width: 120px">
                                ${rs.service_rate}
                            </td>
                        </tr>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="SystemRateContc" >
            <input type="hidden" name="expAllFields" id="d_expAllFields" value="contc_id_name,service_rate" />
            <input type="hidden" name="expFileName" id="d_expFileName" value="运营商服务费率.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead" />
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/SystemRateContcExportAll" />
            ...
            <DIV id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    <tr class="table_edit_tr">
                        ...
                        <td class="table_edit_tr_td_input">
                            <select  name="d_contcID"  id="d_contcID" require="true" dataType="LimitB" min="1" msg="运营商商不能为空">
            ...
            <c:set var="addQueryMethod" scope="request" value="setLineCardNames('detailOp','d_contcID','','','','','');"/>

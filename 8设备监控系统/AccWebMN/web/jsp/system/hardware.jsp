...
<html>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="hardware">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <div id="clearStartHead" class="divForTableBlockHead" >
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="3"  sortedby="asc" onclick="sortForTableBlock('clearStart');">硬件状态</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 250px">备注</td>
                    </tr>
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            <td  id="statusName" class="table_list_tr_col_data_block" >
                                <c:choose>
                                    ...
                                    <c:when test="${rs.status == '3' }">
                                        <b style="color: orange ">${rs.statusName}</b>
                                    </c:when>
                                    <c:otherwise>
                                        ${rs.statusName}
                                    </c:otherwise>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="hardware" >

            <c:set var="divideShow" scope="request" value="1"/>
            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
            
            <input type="hidden" name="expAllFields" id="d_expAllFields"
                   value="getName,getType,getIp,getStatusName,getStatusDate,getRemark" />
            <input type="hidden" name="expFileName" id="d_expFileName" value="硬件状态.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead">
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/HardwareExportAll"/>

 ...
 * @author hejj
 */
public class HandlerTrxNetPaid extends HandlerTrxBase {

    private static Logger logger = Logger.getLogger(HandlerTrxNetPaid.class.getName());
    ...
    private void parseFileName(String fileName,String balanceWaterNo) throws FileNameException {
        ...
        util.parseFmtForTwo(fileName, FileNameParseUtil.FILE_START_TRX_NETPAID);
    ...
    private String getTradType(String line) throws Exception {
        ...
        String trdType = CLASS_PARSER_SHORT_NAME_NETPAID + this.getCharString(b, 0, 2);
        return trdType;
    }

 ...
 */
//票卡更新
public class FileRecordParser56 extends FileRecordParserBase {

    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecord56 r = new FileRecord56();
    ...
    private void handleErrorForUpdateArea(FileRecord56 r){
    ...
    private void setCheckInfo(FileRecord56 r) {
    ...
    private FileRecord00DetailResult getInfoForDevice(FileRecord56 r, char[] b, int offset) throws Exception {
    ...
    private FileRecord00DetailResult getInfoForTrade(FileRecord56 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

 ...
 */
public class CmHisMvTask extends BaskTask {

    private static Logger logger = Logger.getLogger(CmHisMvTask.class);
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.CM_USER + "w_up_dm_cm_his_mv", AppCodeConstant.TYPE_RESULT);

...
import com.goldsign.settle.realtime.app.dao.ExportTccLineInfoDao;
 ...
 * @author hejj
 */
public class TccLineInfo extends FileTccBase {

    private static Logger logger = Logger.getLogger(TccLineInfo.class.getName());
    private static String EXPORT_FILE_NAME = "线路信息";
    private static String PROCEDURE_NAME = "w_up_st_tcc_LineInfo";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccLineInfoDao dao = new ExportTccLineInfoDao();

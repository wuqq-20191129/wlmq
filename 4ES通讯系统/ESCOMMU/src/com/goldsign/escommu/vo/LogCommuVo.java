...
public class LogCommuVo {
    ...
    public String toString() {
        return "LogCommuVo{" + "waterNo=" + waterNo + ", messageId=" + messageId + ", messageName=" + messageName + ", messageFrom=" + messageFrom + ", startTime=" + startTime + ", endTime=" + endTime + ", useTime=" + useTime + ", result=" + result + ", hdlThread=" + hdlThread + ", sysLevel=" + sysLevel + ", sysLevelText=" + sysLevelText + ", timeStart=" + timeStart + ", timeEnd=" + timeEnd + ", remark=" + remark + '}';
    }

 ...
 * @author hejj
 */
public class BufferToQueue63Dao extends BufferToQueueBaseDao{
    ...
    public ResultFromProc bufToQueue(String balanceWaterNo,int balanceWaterNoSub, String fileName) throws Exception {
            return this.bufToQueueCommon(balanceWaterNo,balanceWaterNoSub, fileName, "up_st_trf_btoq_sale_premake");

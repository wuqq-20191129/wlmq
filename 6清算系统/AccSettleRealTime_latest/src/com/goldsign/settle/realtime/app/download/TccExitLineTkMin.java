...
import com.goldsign.settle.realtime.app.dao.ExportTccExitLineTkMinDao;
 ...
 * @author hejj
 */
public class TccExitLineTkMin extends FileTccBase{
     private static Logger logger = Logger.getLogger(TccEntryLineAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟线路分票种出站量";
    private static String PROCEDURE_NAME="w_up_st_tcc_ExitLineTkMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccExitLineTkMinDao dao = new ExportTccExitLineTkMinDao();

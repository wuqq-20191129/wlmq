...
public class FormUtil {
     ...
     * @return cardMainSubs
     */
    public static String getCardMainSubs(List<PubFlag> cardSubs){
        String cardMainSubs ="";
        for(PubFlag cardSub:cardSubs){
            cardMainSubs =cardMainSubs+cardSub.getCode_type()+","+cardSub.getCode()+","+cardSub.getCode_text()+":";
        }
        return cardMainSubs;

...
public class HandlerCommandNtp_iccs extends HandlerCommandBase {

    static Logger logger = Logger.getLogger(HandlerCommandNtp_iccs.class);

    public HandlerCommandNtp_iccs() {
        super();
    }

...
import com.goldsign.settle.realtime.test.file.stl.FileMobileSTL;
import com.goldsign.settle.realtime.test.file.trx.File52App;
import com.goldsign.settle.realtime.test.file.trx.FileNetPaid50App;
 ...
 * @author hejj
 */
public class FileNetPaidORD extends FileBase{
    public static String serialNo = "001";
    public static void main(String[] arg) {
        FileNetPaidORD ft = new FileNetPaidORD();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
       String fileName = "ORD82." + ft.getCurrentDate() + "." + FileNetPaidORD.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
         ...
         */
        /*******************订单数据**************/
        int[] data_type = {FileBase.T_STR,FileBase.T_STR,FileBase.T_STR,FileBase.T_BCD,FileBase.T_BCD,
                           FileBase.T_BCD,FileBase.T_BCD,FileBase.T_BCD,FileBase.T_INT,FileBase.T_INT,
                           FileBase.T_INT,FileBase.T_STR,FileBase.T_STR,FileBase.T_STR,FileBase.T_STR
            
                          
                          };
        int[] data_len = {20,2, 2, 7, 7,
                          2,2,2,4,4,
                          4,1,2,4,11
                          
                                                   
                          };
        Object[] datas = {"012016112500000001", "01","00","20161125120000", "20161125120300",
                           "0100","0201","0207",200,1,
                           400,"0","01","1001","13888888666"
                         };
        /****************************************************************************************/

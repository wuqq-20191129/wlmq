    ...
    <head>
        ...
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">实时客流统计分析类报表--实时车站客运量统计日报
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="RpflStationPassengerDay">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="RpflStationPassengerDay"/>
            ...
            <table  class="table_edit">
                ...
                <!--</tr>-->
                <tr class="table_edit_tr">
                    <c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_date_cur" /> 
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
        ...
        <c:set var="note" scope="request" value="实时车站客运量统计日报"/>

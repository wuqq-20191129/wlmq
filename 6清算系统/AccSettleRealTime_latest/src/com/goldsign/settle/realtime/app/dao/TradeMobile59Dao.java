 ...
 * @author hejj
 */
public class TradeMobile59Dao extends TradeBaseDao{
    private static Logger logger = Logger.getLogger(TradeMobile59Dao.class.getName());
    ...
    public int insertError(FileRecordBase frb,String errCode) throws Exception {
         FileRecordMobile59 vo = (FileRecordMobile59) frb;

        String sql = "insert into "+FrameDBConstant.DB_ST+"W_ST_MB_ERR_LOCK(LINE_ID,STATION_ID,DEV_TYPE_ID,DEVICE_ID,SAM_LOGICAL_ID,"
                                             ...
                                             + "WATER_NO,CARD_APP_MODE,MOBILE_NO,BALANCE_WATER_NO_SUB "
                                             ...
                                             + "?,?,?,?,?,"
                                             + "?,?,?,?,?,"
                                             +FrameDBConstant.DB_ST+ "W_SEQ_W_ST_MB_ERR_LOCK.nextval,?,?,?"
        ...
        Object[] values = {vo.getLineId(),vo.getStationId(),vo.getDevTypeId(),vo.getDeviceId(),vo.getSamLogicalId(),
                           ...
                           vo.getCardAppMode(),vo.getMobileNo(),vo.getBalanceWaterNoSub()

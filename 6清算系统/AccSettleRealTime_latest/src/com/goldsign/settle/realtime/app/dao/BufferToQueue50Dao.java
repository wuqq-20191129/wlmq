 ...
 * @author hejj
 */
public class BufferToQueue50Dao extends BufferToQueueBaseDao {

    private static Logger logger = Logger.getLogger(BufferToQueue50Dao.class.getName());
    ...
    public ResultFromProc bufToQueue(String balanceWaterNo,int balanceWaterNoSub, String fileName) throws Exception {
       // synchronized (SYN) {
            return this.bufToQueueCommon(balanceWaterNo,balanceWaterNoSub, fileName, "up_st_trf_btoq_sale_sjt");
       // }

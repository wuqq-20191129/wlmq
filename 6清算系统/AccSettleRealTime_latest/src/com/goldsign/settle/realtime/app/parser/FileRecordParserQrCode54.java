 ...
 * @author hejj
 */
public class FileRecordParserQrCode54 extends FileRecordParserConstantBase {

    private static Logger logger = Logger.getLogger(FileRecordParserQrCode54.class.getName());

    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecordQrCode54 r = new FileRecordQrCode54();
    ...
    protected FileRecord00DetailResult getInfoForIssueQrCodePlatformFlag(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        ...
        protected FileRecord00DetailResult getInfoForIssueQrCodePlatformFlagFromFile(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    protected FileRecord00DetailResult getInfoForIssueQrCodePlatformFlagFromDefault(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    protected FileRecord00DetailResult getInfoForDevice(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

        int len = 2;
        r.setTrdType(this.getTrdTypeForQrCode(this.getCharString(b, offset, len)));//交易类型 交易类型增加QrCode标识
        offset += len;
        //
        len = 2;
    ...
    /*
    private FileRecord00DetailResult getInfoForOctDiscount(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result;
     ...
     */
    protected FileRecord00DetailResult getInfoForOctDiscountFile(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
    ...
    protected FileRecord00DetailResult getInfoForQrCode(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
       ...
       // r.setBusinessWaterNoRel(this.getCharString(b, offset, len));//相关业务流水
        //20200914乱码处理
        r.setBusinessWaterNoRel((this.getCharString(b, offset, len)).trim());//相关业务流水
    ...
    /*
    private FileRecord00DetailResult getInfoForOctDiscountDefault(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
     ...
     */
    protected FileRecord00DetailResult getInfoForTrade(FileRecordQrCode54 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
...
//add 20180309
    ...
    protected void setCheckInfo(FileRecordQrCode54 r) {
    ...
    private String getCheckUniqueKey(FileRecordQrCode54 r) {
        //唯一性校验主健
        //票卡类型+卡逻辑卡号+SAM逻辑卡号+SAM卡交易序号+交易时间+交易金额+余额
    ...
    private void setTac(FileRecordQrCode54 r) {

 ...
 * @author hejj
 */
public class File08TicketWaste extends FileBase{
    public static void main(String[] arg) {
        File08TicketWaste ft = new File08TicketWaste();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0108."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0108", "20130810100000", "20130810100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"08", "020102001",  "000001", 1,this.getDealDatetime(), 
                           100, 200};
        /****************************************************************************************/

...
public class NtpLccSynAct extends BaseAction {
    ...
    public ActionMessage query(HttpServletRequest request, NtpLccSynDao pmb, Vector statues, String command) throws Exception {

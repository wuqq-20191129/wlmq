 ...
 */
//非单程票售票记录
public class FileRecordParser51 extends FileRecordParserBase {

    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecord51 r = new FileRecord51();
    ...
    private FileRecord00DetailResult getInfoForTrade(FileRecord51 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();
        ...
        len = 2;
        r.setDepositFee(this.getShort(b, offset));//13金额

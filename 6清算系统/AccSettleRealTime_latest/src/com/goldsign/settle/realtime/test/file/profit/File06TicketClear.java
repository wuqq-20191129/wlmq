 ...
 * @author hejj
 */
public class File06TicketClear extends FileBase{
     public static void main(String[] arg) {
        File06TicketClear ft = new File06TicketClear();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0106."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0106", "20130810100000", "20130810100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"06", "020102001",  "000001", this.getDealDatetime(),1, 
                          "0100", 100, "0101", 200};
        /****************************************************************************************/

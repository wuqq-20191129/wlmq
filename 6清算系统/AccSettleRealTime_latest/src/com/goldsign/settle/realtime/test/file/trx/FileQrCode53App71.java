 ...
 * @author mh
 */
public class FileQrCode53App71 extends FileBase{
     public static String serialNo = "053";

    public static void main(String[] arg) {
        FileQrCode53App71 ft = new FileQrCode53App71();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX7100." + ft.getCurrentDate() + "." + File53App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] datas = {
            "53", "13", "0102", "04", "001",
            "000000008A654672", 100, "1242", "0101011234567010", "8A563201",
            this.getDealDatetime(), 108, 9800, "0", "000",
            "0000", "0000", "0", 100, "1",
            this.getDealDatetime(),"201901",5000,180,this.getDealDatetime(),
            "0000000000000000000000000000000000000001","18899990000","02"
        };
        /**
         * *****************进站信息*************
         */

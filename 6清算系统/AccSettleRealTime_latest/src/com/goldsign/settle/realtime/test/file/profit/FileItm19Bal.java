 ...
 * @author hejj
 */
public class FileItm19Bal extends FileBase{
    public static void main(String[] arg) {
        FileItm19Bal ft = new FileItm19Bal();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0119."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0119", "20131106100000", "20131106100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"19", "020102001", this.getDealDatetime(),this.getDealDatetime(), 100,

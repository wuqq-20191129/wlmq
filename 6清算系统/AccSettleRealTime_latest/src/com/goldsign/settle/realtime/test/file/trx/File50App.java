 ...
 * @author hejj
 */
public class File50App extends FileBase {

    public static String serialNo = "050";

    public static void main(String[] arg) {
        File50App ft = new File50App();
        // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "TRX0110." + ft.getCurrentDate() + "." + File50App.serialNo;
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        int[] data_type = {
            ...
            T_INT, T_STR, T_STR, T_INT, T_INT,
            T_BCD, T_BCD, T_STR, T_BCD, T_INT,
        ...
        Object[] datas = {
            "50", "11", "0101", "04", "001",
            "000000008A654672", 100, this.getDealDatetime(), "01", "00000000000000000000",
            10, "0101011234567010", "8A563201", 132, 50,
            "0100", "00", "5AD43781", "02", 0,
            "000001", "99", 0, "0", "05",
            "830000000001","20190103000001"
        };
        Object[] datas_1 = {
            "50", "12", "0101", "04", "001", 
            "000000008A654673",100, this.getDealDatetime(), "01", "00000000000000000000", 
            10,"0101011234567010", "8A563201", 132, 50,
            "0100","00", "5AD43781", "02", 0,
            "000001","99", 0, "0", "05", 
            "830000000001","20190103000002"
        };
        /**
         * *****************单程票发售信息*************
         */

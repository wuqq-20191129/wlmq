 ...
 * @author goldsign
 */
public class TestSocket35 extends Thread{
...
//    public static final String ipAddress = "127.0.0.1";
    ...
    public static void main(String[] args) {
        TestSocket35 myThread;
        myThread = new TestSocket35();
        myThread.run();
    }
...
//                }else if(i==2){
                ...
                if(dataType==3){
                    ...
                    sb.append(","+getBcdString(data, 42, 2));//
                    sb.append(","+getCharString(data, 44, 20));//
                    sb.append(","+getLong(data, 64));//系统参照编号
                    sb.append(","+getCharString(data, 68, 2));//
                    sb.append(","+getCharString(data, 70, 2));//
...
//                    socket.close();
    ...
    private byte[] data(){
        byte[] b = new byte[154];
        System.arraycopy("35".getBytes(), 0, b, 0, 2);//消息类型
        ...
        System.arraycopy(longStringToByteArray(0L,4), 0, b, 104, 4);//终端处理流水号
        System.arraycopy("1".getBytes(), 0, b, 108, 1);//
        System.arraycopy(longStringToByteArray(0L,4), 0, b, 109, 4);//
        System.arraycopy(longStringToByteArray(0L,4), 0, b, 113, 4);//
        System.arraycopy("14".getBytes(), 0, b, 117, 2);//
        System.arraycopy("1".getBytes(), 0, b, 119, 1);//
        System.arraycopy(longStringToByteArray(0L,4), 0, b, 120, 4);//
        System.arraycopy(longStringToByteArray(0L,4), 0, b, 124, 4);//
        System.arraycopy("00000000".getBytes(), 0, b, 128, 8);//
        System.arraycopy("0".getBytes(), 0, b, 136, 1);//
        System.arraycopy("000000".getBytes(), 0, b, 137, 6);//
        System.arraycopy(longStringToByteArray(1L,4), 0, b, 143, 4);//
        System.arraycopy(bcdStringToByteArray("20171112101000"), 0, b, 147, 7);//

 ...
 public Dev(int x, int y , String dev_id, String name, String direction)
   ...
   class Device
   {
      ...
      public Device(String url,String type)
     {
       ...
       img_url = url;
       dev_type = type;
       if (type.equals("07")) description = "验票机";
       else if(type.equals("02")) description = "自动售票机";
       else if(type.equals("03")) description = "票务室";

       //双向闸机：06，单向进闸机：04，单向出闸机：05，
       else if(type.equals("06")) description = "双向闸机";
       else if(type.equals("04")) description = "进站闸机";
       else if(type.equals("05")) description = "出站闸机";

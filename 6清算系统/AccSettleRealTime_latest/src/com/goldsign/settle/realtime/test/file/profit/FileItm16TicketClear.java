 ...
 * @author hejj
 */
public class FileItm16TicketClear extends FileBase{
    public static void main(String[] arg) {
        FileItm16TicketClear ft = new FileItm16TicketClear();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0116."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0116", "20130810100000", "20130810100059", 1};
        /*********************************************/
        /******************文件尾***********************/
         ...
         */
        /*******************硬币箱数据**************/
        int[] data_type = {File52App.T_BCD, File52App.T_STR, File52App.T_STR, File52App.T_BCD, File52App.T_INT,
                           File52App.T_BCD, File52App.T_INT, File52App.T_BCD, File52App.T_INT
                          };
        int[] data_len = {1, 9, 6, 7, 2,
                          2, 2, 2, 2 
                          
                          };
        Object[] datas = {"16", "020102001",  "000001", this.getDealDatetime(),1, 
                          "0100", 100, "0101", 200};
        /****************************************************************************************/
    ...
    public char[] getBufferCharForLine() throws UnsupportedEncodingException {
        ...
        Object[] datas = {"06", "020102001",  "000001", this.getStartTime(),1, 
                          "0100", 100, "0101", 200};
        /****************************************************************************************/

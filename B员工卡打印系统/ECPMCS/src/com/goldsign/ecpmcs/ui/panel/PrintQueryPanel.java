...
import com.goldsign.ecpmcs.service.impl.PrintService;
 ...
 */
public class PrintQueryPanel extends javax.swing.JPanel {

    private IPrintService printService;
    
    private JTable resultSetTableMain;
    //列宽度
    private  int[] columnSize = {200, 100, 200, 150, 120, 120, 40, 100, 200, 250};
    /** Creates new form GenIssueRequestPanel */
    public PrintQueryPanel() {
    ...
    private void genMainResultSetTable(List<Object[]> result) {
        //列名称
        String[] columnNames = {"姓名", "证件类型", "证件号", "票卡类型", "职务", "部门", "性别", "操作员", "打印时间", "相片名称"};
        //列宽度
        //int[] columnSize = {70, 100, 200, 150, 120, 120, 40, 100, 200, 250, 0, 0, 0, 0};
        //生成列表
        resultSetTableMain = UIUtil.genResultSetTable(this.mainSPn, result, columnNames, columnSize);
        //UIUtil.hideTableColumns(resultSetTableMain, new int[]{10, 11, 12, 13});//隐藏列
    }

<%--
    Document   : ticketStorageOutBorrowPlan
...
<html>
    ...
    <body onload="preLoadVal('q_beginTime', 'q_endTime',90);
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageOutBorrowManage">
            <!-- 页面用到的变量 通用模板 -->
            <c:set var="divideShow" scope="request" value="1"/>
            <c:import  url="/jsp/common/common_template_web_variable.jsp?template_name=common_web_variable" />
            <table  class="table_edit">
                <tr class="table_edit_tr">
                    <td class="table_edit_tr_td_label">借票单号:</td>
                    <td class="table_edit_tr_td_input">
                        <input type="text" id="q_billNo" name="q_billNo" value="" size="12" maxlength="12"  require="false" dataType="NumAndEng" min="12" max="12"  msg="计划单号应为12位，由数字和字母组成" />
                    </td>
                    <td class="table_edit_tr_td_label">领票人:</td>
                    <td class="table_edit_tr_td_input">
                        <input type="text" id="q_operator" name="q_operator" value="" size="12" maxlength="45" require="false" dataType="LimitContainChinese" min="1" max="45" msg="领票人不能为空且最大45个字节，一个中文3个字节(最大15个中文)" />
                    </td>
                ...
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_input">
                        <select id="q_unitId" name="q_unitId"  require="false" dataType="NotEmpty"
                                msg="借票单位不能为空">
                ...
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_label" rowspan="1">
                        ...
                        <c:set var="addClickMethod" scope="request" value="setControlNames('queryOp','q_billNo#q_operator#q_recordFlag#q_beginTime#q_endTime#q_unitId#q_cardMainCode#q_cardSubCode#q_storage');setLineCardNames('queryOp','','','','q_cardMainCode','q_cardSubCode','commonVariable');"/>
                ...
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        <td   class="table_list_tr_col_head_block">
                            <input type="checkbox" name="rectNoAll" id="rectNoAll" onclick="selectAllRecord('detailOp', 'rectNoAll', 'rectNo', 'clearStart', 0);controlsDisableForMulRecords('detailOp', ['del']);controlsByFlagAndMul('detailOp', ['audit']);setPageControl('detailOp');"/>
                        </td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="1"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 100px">借票单号</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="3"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 100px">单据状态</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="4"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 80px">制单人</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 120px">制单日期</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="6"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 80px">审核人</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="7"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 120px">审核时间</td>
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="8"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 80px">车票管理员</td>
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="10"  sortedby="asc" onclick="sortForTableBlock('clearStart');" style="width: 100px">借票单位</td>
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);"
                            ...
                            <td  id="billNo" class="table_list_tr_col_data_block" style="width: 100px">
                                <a href='#'
                                   onClick="openwindow('ticketStorageOutBorrowManage?queryCondition=${rs.billNo}&command=queryDetail&operType=planDetail&billRecordFlag=${rs.recordFlag}&ModuleID=${ModuleID}&_divideShow=0', '', 1200, 800)">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td  id="outBillNo" class="table_list_tr_col_data_block" style="width: 100px">
                                        <a href='#'
                                           onClick="openwindow('ticketStorageOutBorrowManage?queryCondition=${rs.outBillNo}&command=query&operType=outBill&billRecordFlag=${rs.recordFlag}&ModuleID=${ModuleID}', '', 1300, 600)">
                                            <!--  <a href='#' onClick="window.showModelessDialog('ticketStorageOutProduceManage.do?queryCondition={billNo}&amp;command=queryDetail&amp;operType=planDetail&amp;ModuleID={/Service/Result/ModuleID}','0','dialogWidth:700px;dialogHeight:500px;center:yes;resizable:no;status:no;scroll:no')"> -->
                                            ${rs.outBillNo}
                                        </a>
                                    </td>
                            ...
                            <td  id="receiveMan" class="table_list_tr_col_data_block" style="width: 80px"">
                             ...
                             <td  id="unitId" class="table_list_tr_col_data_block" style="width: 100px"">
                                ${rs.unitName}
                            </td>
                            <td  id="remarks" class="table_list_tr_col_data_block" style="width: 250px">
                                ${rs.remark}
                            </td>
                        </tr>
                    </c:forEach>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="ticketStorageOutBorrowManage" >
			...
			value="getBillNo,getOutBillNo,getRecordFlagName,getFormMaker,getBillDate,getVerifyPerson,getVerifyDate,getDistributeMan,getReceiveMan,getUnitName,getRemark" />
			<!--导出文件名字 生成的Excel sheet的名字也是这个-->
			<input type="hidden" name="expFileName" id="d_expFileName" value="借票出库.xlsx" />
			<!--需要导出页面的表数据  一个页面多个导出全部根据这里设置详情参看运营系统退款模块-->
			<input type="hidden" name="divId" id="d_divId" value="clearStartHead">
			<!--对应你controller写的方法  一个页面多个导出全部根据这里设置详情参看运营系统退款模块-->
			<input type="hidden" name="methodUrl" id="d_methodUrl" value="/TicketStorageOutBorrowExportAll"/>
                    ...
                    <tr class="table_edit_tr">
                        ...
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_distributeMan" id="d_distributeMan" size="15"
                                   require="true" dataType="NotEmpty|LimitContainChinese" maxlength="45" min="1" max="45" msg="车票管理员不能为空且最大45个字节，一个中文3个字节(最大15个中文)"/>
                        </td>
                        <td class="table_edit_tr_td_label">领票人: </td>
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_receiveMan" id="d_receiveMan" size="15"
                                   require="true" dataType="NotEmpty|LimitContainChinese" maxlength="45" min="1" max="45" msg="领票人不能为空且最大45个字节，一个中文3个字节(最大15个中文)"/>
                        </td>
                    </tr>
                    <tr class="table_edit_tr">
                        <td class="table_edit_tr_td_label">借票单位：</td>
                        <td class="table_edit_tr_td_input">
                            <select id="d_unitId" name="d_unitId"  require="true" dataType="NotEmpty"
                                    msg="借票单位不能为空">
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_outreason_borrow_until" />
                            </select>
                        </td>
                        ...
                        <td class="table_edit_tr_td_input">
                            <input type="text" name="d_remarks" id="d_remarks" size="80" require="false" maxlength="256" dataType="LimitContainChinese" min="1" max="256" msg="备注最大长度为256个字节，一个中文是3个字节(最大85个中文)"/>
                        </td>
                    </tr>
                </table>
            </div>

...
public class DiskAct extends BaseAction {
    ...
    private void convertText(Vector statues) throws Exception {
        ...
        for (int i = 0; i < statues.size(); i++) {
            vo = (DiskVo) statues.get(i);
            vo.setStatusText(dbUtil.getTextByCode(vo.getStatus(), statuesFlags));
        }
    }

    public ActionMessage query(HttpServletRequest request, DiskDao pmb, Vector statues, String command) throws Exception {

 ...
 * @author hejj
 */
public class File02NoteData extends FileBase {

    public static void main(String[] arg) {
        File02NoteData ft = new File02NoteData();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName = "PRO0102." + ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0102", "20131106100000", "20131106100059", 1};
        /**
         * ******************************************
         */
        /**
        ...
        Object[] datas = {"02", "020102001", "1", "000001", this.getDealDatetime(),
            this.getDealDatetime(), 100, 13,
            1000, 5000, 
            100000,200000,
             0,0,
             0, 0,
    ...
    public char[] getBufferCharForLine() throws UnsupportedEncodingException {
        ...
        Object[] datas = {"02", "020102001", 1, "000001", this.getStartTime(),
            this.getEndTime(), 100, 1000, 5000, 100000,
            200000, 0, 0, 0, 0,
            0, 0, 0, 0, 0,
            100, 100, 100, 100, 100,
            100, 100, 100, 100, 100,

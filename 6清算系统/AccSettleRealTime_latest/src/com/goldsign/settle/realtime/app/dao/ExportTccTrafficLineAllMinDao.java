 ...
 * @author hejj
 */
public class ExportTccTrafficLineAllMinDao extends ExportTccBaseDao{
    private static Logger logger = Logger.getLogger(ExportTccTrafficLineAllMinDao.class.getName());
    ...
    protected String getRecord(DbHelper dbHelper) throws Exception {
        ...
        //最后字段
        sb.append(dbHelper.getItemValue("passengers") );//客运量

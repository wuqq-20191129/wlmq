 ...
 * @author hejj
 */
public class ExportTccExitLineAllMinDao extends ExportTccBaseDao{
     private static Logger logger = Logger.getLogger(ExportTccExitLineAllMinDao.class.getName());

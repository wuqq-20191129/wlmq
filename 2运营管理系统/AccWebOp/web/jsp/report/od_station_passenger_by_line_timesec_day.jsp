    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/frame/simple.css" title="Style"/>
            ...
            <body onload="initDocument('queryOp', '');
                    ...
                    setLinkText('queryOp','3','lineID#mainType#subType');"
            >
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">OD分析类报表--票卡时段 OD 分析日报
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="OdStationPassengerByLineTimesecDay">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="OdStationPassengerByLineTimesecDay"/>
            ...
            <table  class="table_edit">
                ...
                <!--</tr>-->
                <tr class="table_edit_tr">
                    <c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_date" /> 
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_lineID" /> 
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_mainType" /> 
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_subType" /> 
</tr>
<tr class="table_edit_tr">
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
                    ...
                    <td class="table_edit_tr_td_label">
                        ...
                        <c:set var="reportType" scope="request" value="3"/>
                        <c:set var="controlNames" scope="request" value="lineID#mainType#subType"/>
        ...
        <c:set var="note" scope="request" value="票卡时段 OD 分析日报"/>

...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="记名卡生产报表"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_begin_day#p_end_day#p_card_main_type#p_card_sub_type"/>
            <c:set var="QueryDateNames" scope="request" value="p_begin_day#p_end_day"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_card_main_type#p_card_sub_type#p_begin_day#p_end_day#bufferFlag"/>
            ...
            <table class="table_edit">
                ...
                <tr class="table_edit_tr">
                    ...
                    <td colspan="7">
                        <div align="left">查询条件的日期为生产工作单制单日期</div>
                    </td>
                </tr>
            </table>
        </form>

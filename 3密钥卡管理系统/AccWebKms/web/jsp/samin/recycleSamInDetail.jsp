                ...
                <table class="table_list_block" id="DataTable" >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        <tr class="table_list_tr_data"  onMouseOver="overResultRow('detailOp', this);" 
                            ...
                            <td  id="startLogicNo" class="table_list_tr_col_data_block" style="width: 150px">
                                ${rs.startLogicNo}
                            </td>
                            <td  id="endLogicNo" class="table_list_tr_col_data_block" style="width: 150px">
                                ${rs.endLogicNo}
                            </td>

 ...
 * @author hejj
 */
public class File03CoinPut extends FileBase{
    public static void main(String[] arg) {
        File03CoinPut ft = new File03CoinPut();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0103."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0103", "20131106100000", "20131106100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"03", "020102001", 1, "000001", this.getDealDatetime(), 
                          100, 200, 100, 2000};
        /****************************************************************************************/

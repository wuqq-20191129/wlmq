...
import com.goldsign.settle.realtime.app.dao.ExportTccExitStationTkMinDao;
 ...
 * @author hejj
 */
public class TccExitStationTkMin extends FileTccBase{
     private static Logger logger = Logger.getLogger(TccEntryStationAllMin.class.getName());
    private static String EXPORT_FILE_NAME = "5分钟车站分票种出站量";
     private static String PROCEDURE_NAME="w_up_st_tcc_ExitStationTkMin";

    @Override
    public String genFileTcc(String balanceWaterNo, String fileNameBase) throws Exception {
        //获取数据
        ExportTccExitStationTkMinDao dao = new ExportTccExitStationTkMinDao();

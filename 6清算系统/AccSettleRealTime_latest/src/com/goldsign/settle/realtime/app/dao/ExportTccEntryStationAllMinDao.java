 ...
 * @author hejj
 */
public class ExportTccEntryStationAllMinDao extends ExportTccBaseDao {

    private static Logger logger = Logger.getLogger(ExportTccEntryStationAllMinDao.class.getName());

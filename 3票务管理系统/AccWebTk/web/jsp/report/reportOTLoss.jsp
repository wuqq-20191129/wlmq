<%-- 
    Document   : ReportOTLoss
    Created on : 2017-8-29, 14:52:05
    Author     : zhouyang
--%>
...
<html>
    <head>
        ...
        <!--设置报表title-->
        <c:set var="reportTitle" scope="request" value="流失量统计"/>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="ticketStorageReportManage">
            ...
            <c:set var="ParameterNames" scope="request" value="p_storage_id#p_year"/>
            <!--查询条件-->
            <c:set var="ControlNames" scope="request" value="p_storage_id#p_year#bufferFlag"/>
            ...
            <table class="table_edit">
                <tr class="table_edit_tr">
                    ...
                    <!--年份-->
                    <c:import url="/jsp/common/common_template_report.jsp?template_name=common_template_report_qry_con_p_begin_year" />
                ...
                <tr class="table_edit_tr">
                    ...
                    <td colspan="7">
                        <div align="left">查询条件的日期为出入库单的审核日期</div>
                    </td>
                </tr>
            </table>
        </form>

...
<html>
    ...
    <body onload="
        ...
        <form method="post" name="queryOp" id="queryOp" action="netCard">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <div id="clearStartHead" class="divForTableBlockHead" >
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=false index="3"  sortedby="asc" onclick="sortForTableBlock('clearStart');">网卡状态</td>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="netCard" >
            ...
            <input type="hidden" name="expFileName" id="d_expFileName" value="网卡状态.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead">
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/NetCardExportAll"/>

 ...
 * @author hejj
 */
public class ExportOctJY extends ExportBase {
     private static Logger logger = Logger.getLogger(ExportOctJY.class.getName());

    private static final int[] format = {16, 1, 14, 8, 16,
                                         16, 4, 4, 16, 14,
                                          8, 8, 8, 2, 16,
                                          14,6,6,8,4,
                                          4,4,16,14
    ...
    public String genExportFiles(String balanceWaterNo,int balanceWaterNoSub,String seq) throws Exception {
        ExportOctJYDao dao = new ExportOctJYDao();
        ...
        String fileName = this.getExportFileName(ExportBase.DATA_TYPE_TRX,ExportBase.SERVICER_MTR, ExportBase.PLACE_MTR,  balanceWaterNo,seq);

 ...
 * @author hejj
 */
public class ExportTccExitStationTkMinDao extends ExportTccBaseDao{
    private static Logger logger = Logger.getLogger(ExportTccExitStationTkMinDao.class.getName());
    ...
    protected String getRecord(DbHelper dbHelper) throws Exception {
        ...
        sb.append(dbHelper.getItemValue("card_main_id") +dbHelper.getItemValue("card_sub_id")+ this.FIELD_DELIM);//票种
        //最后字段

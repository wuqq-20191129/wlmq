 ...
 * @author zhangjh
 */
public class AnalyzeMessage09 extends com.goldsign.commu.frame.message.AnalyzeMessageBase {
	private static Logger logger = Logger.getLogger(AnalyzeMessage09.class
			.getName());

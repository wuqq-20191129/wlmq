 ...
 * 12.15. ITM车票存入数据
 */
public class FileItm15TicketPut extends FileBase{
    public static void main(String[] arg) {
        FileItm15TicketPut ft = new FileItm15TicketPut();
        //String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0115."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0115", "20130810100000", "20130810100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"15", "020102001", 1, "000001", "1", 
                          this.getDealDatetime(), 100, "0100", 200};
        /****************************************************************************************/

 ...
 */
public class StRptMvTask2 extends BaskTask {

    private static Logger logger = Logger.getLogger(StRptMvTask2.class);
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.OP_USER + "w_up_dm_st_rpt_mv2", AppCodeConstant.TYPE_RESULT);

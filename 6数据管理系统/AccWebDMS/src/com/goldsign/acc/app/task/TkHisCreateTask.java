 ...
 */
public class TkHisCreateTask extends BaskTask {

    private static Logger logger = Logger.getLogger(TkHisCreateTask.class);
    private String taskName;

    public TkHisCreateTask() {
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.TK_USER + "w_up_dm_tk_his_create", AppCodeConstant.TYPE_RESULT);

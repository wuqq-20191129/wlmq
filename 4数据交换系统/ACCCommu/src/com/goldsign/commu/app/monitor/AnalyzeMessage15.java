 ...
 * @author zhangjh
 */
public class AnalyzeMessage15 extends com.goldsign.commu.frame.message.AnalyzeMessageBase {
	private static Logger logger = Logger.getLogger(AnalyzeMessage15.class
			.getName());

                    ...
                    <DIV id="detail" align="center" style="position:relative; left:20; width:95%; height:10; layer-background-color:#99CC99; border:thin outset #ffffff; z-index:1;">
                        ...
                        <table width="95%" align="center" class="tableStyle">
                            <tr align="center" class="trContent" height="30">
                                ...
                                <td width="15%"><div align="left"><input type="password" name="password"  dataType="SafeString" maxLength="8" size="10" msg="密码应包含字母、数字和特殊符号的一种以上，不允许出现空间，6位的长度"/></div></td>
                            </tr>
                            <tr align="center" class="trContent" height="30">
                                <td width="11%"><div align="right">再输入新密码:</div></td>
                                <td width="15%"><div align="left"><input type="password" name="againPassword" maxLength="8" size="10" dataType="Repeat" to="password" msg="两次输入的密码不一致"/></div></td>
                            </tr>
                            <tr align="center" class="trContent" height="30">
                                <td width="11%">
                                    <div align="right">

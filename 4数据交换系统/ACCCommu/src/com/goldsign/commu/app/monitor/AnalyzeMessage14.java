 ...
 * @author zhangjh
 */
public class AnalyzeMessage14 extends com.goldsign.commu.frame.message.AnalyzeMessageBase {
	private static Logger logger = Logger.getLogger(AnalyzeMessage14.class
			.getName());

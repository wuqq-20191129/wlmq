 ...
 * @author hejj
 */
public class FileWriter74 extends FileWriterQrCode54{
     @Override
    public String getLine(FileRecordBase vob) {
        FileRecord74 vo = (FileRecord74) vob;
        ...
        sb.append(vo.getTctActiveDatetime()+ FileWriterBase.FIELD_DELIM);//次票激活时间20191110

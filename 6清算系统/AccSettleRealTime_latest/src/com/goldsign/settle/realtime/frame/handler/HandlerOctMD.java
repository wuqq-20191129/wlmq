 ...
 * @author hejj
 */
public class HandlerOctMD extends HandlerOctBase{
    private static Logger logger = Logger.getLogger(HandlerOctMD.class.getName());
    ...
    public void parseFileName(String fileName) throws FileNameException {
        ...
        util.parseFmtForOctImport(fileName, FileNameParseUtil.FILE_START_OCT_BLL);

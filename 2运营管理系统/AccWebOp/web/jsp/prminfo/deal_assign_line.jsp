<%-- 
    Document   : deal_assign_line
    Created on : 2017-6-15, 19:10:18
    Author     : liudezeng
--%>
    ...
    <c:choose>
        <c:when test="${version.version_no == '0000000000'}">
            <body onload="initDocument('queryOp', 'detail');
                    ...
                    setPrimaryKeys('detailOp', 'd_b_line_id#d_b_station_id#d_e_line_id#d_e_station_id#d_line_id_dispart');
                    setControlsDefaultValue('queryOp');
                    setListViewDefaultValue('detailOp', 'clearStart');
                    setQueryControlsDefaultValue('queryOp', 'detailOp');
                    setPageControl('detailOp');setTableRowBackgroundBlock('DataTable')">
            </c:when>
            <c:otherwise>
            <body onload="initDocument('queryOp', 'detail');
                    initDocument('detailOp', 'detail');
        ...
        <form method="post" name="queryOp" id="queryOp" action="DealAssignLine">
            <!-- 页面用到的变量 通用模板 -->
            ...
            <table  class="table_edit">
                <tr class="table_edit_tr">
                    ...
                    <td class="table_edit_tr_td_label">分账线路:</td>
                    <td class="table_edit_tr_td_input">
                        <select id="q_line_id_dispart" name="q_line_id_dispart" >				    
                            <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_line" />
                        </select>
                    </td>
                    ...
                    <td class="table_edit_tr_td_label" rowspan="2">
                        ...
                        <c:set var="addClickMethod" scope="request" value="setControlNames('queryOp','q_b_line_id#q_b_station_id#q_e_line_id#q_e_station_id#q_line_id_dispart');setLineCardNames('queryOp','q_b_line_id','q_b_station_id','commonVariable','q_e_line_id','q_e_station_id','commonVariable1');"/>
...
<c:import url="/jsp/common/common_template.jsp?template_name=common_status_table" />
            ...
            <div id="clearStartHead" class="divForTableBlockHead">
                <table class="table_list_block" id="DataTableHead" >
                    ...
                    <tr  class="table_list_tr_head_block" id="ignore">
                        ...
                        <td id="orderTd"    class="table_list_tr_col_head_block"  isDigit=true index="5"  sortedby="asc" onclick="sortForTableBlock('clearStart');" >分账线路</td>
            ...
            <div id="clearStart"  class="divForTableBlockData">
                <table class="table_list_block" id="DataTable" >
                    ...
                    <c:forEach items="${ResultSet}" var="rs">
                        ...
                        id="${rs.b_line_id}#${rs.b_station_id}#${rs.e_line_id}#${rs.e_station_id}#${rs.line_id_dispart}#${rs.in_percent}#${rs.version_no}#${rs.record_flag}"
                        idStartLine="${rs.b_line_id}" idDestLine="${rs.e_line_id}">
                            ...
                            <td  id="line_id_dispart" class="table_list_tr_col_data_block">
                                ${rs.line_id_dispart_name}
                            </td>
        ...
        <FORM method="post" name="detailOp" id="detailOp" action="DealAssignLine" >
            <input type="hidden" name="importUrl" id="importUrl" value="DealAssignLine?command=importLine" />
            <input type="hidden" name="expAllFields" id="d_expAllFields" value="b_line_id_name,b_station_id_name,e_line_id_name,e_station_id_name,line_id_dispart_name,in_percent" />
            <input type="hidden" name="expFileName" id="d_expFileName" value="线路交易分配比例.xlsx" />
            <input type="hidden" name="divId" id="d_divId" value="clearStartHead" />
            <input type="hidden" name="methodUrl" id="d_methodUrl" value="/DealAssignLineExportAll" />
            ...
            <DIV id="detail"  class="divForTableDataDetail" >
                <table  class="table_edit_detail">
                    <tr class="table_edit_tr">
                        ...
                        <td class="table_edit_tr_td_label">分账线路:</td>
                        <td class="table_edit_tr_td_input">
                            <select  name="d_line_id_dispart"  id="d_line_id_dispart"  require="true" dataType="LimitB" min="1" msg="分账线路不能为空">
                                <c:import url="/jsp/common/common_template.jsp?template_name=option_list_pub_line" />
                            </select>	
                        </td>
            ...
            <c:set var="addQueryMethod" scope="request" value="setLineCardNames('queryOp','d_b_line_id','d_b_station_id','commonVariable','d_e_line_id','d_e_station_id','commonVariable1','d_line_id_dispart','commonVariable1');"/>
            <c:set var="addClickMethod" scope="request" value="setUpdatePrimaryKey('detailOp','d_b_line_id#d_b_station_id#d_e_line_id#d_e_station_id#d_line_id_dispart#Version');"/>

 ...
 * @author hejj
 */
public class FileRecordParser16 extends FileRecordParserBase{
    @Override
    public Object parse(String line, FileRecordAddVo lineAdd) throws RecordParseForFileException {
        FileRecord16 r = new FileRecord16();
    ...
    private FileRecord00DetailResult getInfoForCommon(FileRecord16 r, char[] b, int offset) throws Exception {
    ...
    private FileRecord00DetailResult getInfoForOther(FileRecord16 r, char[] b, int offset) throws Exception {
        FileRecord00DetailResult result = new FileRecord00DetailResult();

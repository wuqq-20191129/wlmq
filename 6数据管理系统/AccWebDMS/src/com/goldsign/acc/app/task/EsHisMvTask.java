 ...
 */
public class EsHisMvTask extends BaskTask {


    private static Logger logger = Logger.getLogger(EsHisMvTask.class);
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.TK_USER + "w_up_dm_es_his_mv", AppCodeConstant.TYPE_RESULT);

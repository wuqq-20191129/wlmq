 ...
 * @author hejj
 */
public class HandlerTrxMobile extends HandlerTrxBase {

    private static Logger logger = Logger.getLogger(HandlerTrxMobile.class.getName());
    ...
    private void parseFileName(String fileName,String balanceWaterNo) throws FileNameException {
        ...
        util.parseFmtForTwo(fileName, FileNameParseUtil.FILE_START_TRX_MOBILES);
    ...
    private String getTradType(String line) throws Exception {
        ...
        String trdType = CLASS_PARSER_SHORT_NAME_MOBILE + this.getCharString(b, 0, 2);
        return trdType;
    }

    ...
    <head>
        ...
        <table  class="table_title">
            <tr align="center" class="trTitle">
                <td colspan="4">设备寄存器报表--线路 BOM 寄存器数据日报表
                </td>
            </tr>
        </table>
        ...
        <!--<form method="post" name="queryOp" id="queryOp" action="DevBomDay">-->
        <form method="post" name="queryOp" id="queryOp" action="Report">
            <!-- 椤甸潰鐢ㄥ埌鐨勫彉閲� 閫氱敤妯℃澘 -->
            <input type="hidden" name="actionName" value="DevBomDay"/>
...
<c:import url="/jsp/report/report_qry_template.jsp?template_name=op_report_qry_con_isBalanceDate" /> 
        ...
        <c:set var="note" scope="request" value="线路 BOM 寄存器数据日报表"/>

 ...
 * @author hejj
 */
public class ExportTccTurnLineAllMinDao extends ExportTccBaseDao{
     private static Logger logger = Logger.getLogger(ExportTccTurnLineAllMinDao.class.getName());
    ...
    protected String getRecord(DbHelper dbHelper) throws Exception {
        ...
        //最后字段
        sb.append(dbHelper.getItemValue("total_distance") );//客运周转量

 ...
 * @author hejj
 */
public class File13AutoBal extends FileBase{
     public static void main(String[] arg) {
        File13AutoBal ft = new File13AutoBal();
       // String path="D:/en_work/dir_prog_work/settle/模拟数据/程序生成";
        String fileName="PRO0113."+ft.getCurrentDate();
        try {
    ...
    public char[] getBufferChar() throws UnsupportedEncodingException {
        ...
        Object[] data_head = {"0113", "20131106100000", "20131106100059", 1};
        /*********************************************/
        /******************文件尾***********************/
        ...
        Object[] datas = {"13", "020102001", this.getDealDatetime(),this.getDealDatetime(), 10000,

 ...
 */
public class StRptCreateTask1 extends BaskTask {

    private static Logger logger = Logger.getLogger(StRptCreateTask1.class);
    private String taskName;

    public StRptCreateTask1() {
        ...
        try {
            if (judgeRun()) {
                ...
                if (0 == status) {
                    ...
                    hmParm = service.doTask(DBConstant.OP_USER + "w_up_dm_st_rpt_create1", AppCodeConstant.TYPE_RESULT);
